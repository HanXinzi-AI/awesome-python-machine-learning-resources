...
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 2.5M · ⏱️ 30.04.2021):
	...
	```
- [Docker Hub](https://hub.docker.com/r/tensorflow/tensorflow) (📥 51M · ⭐ 1.9K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/scikit-learn/scikit-learn) (👨‍💻 2.2K · 🔀 21K · 📥 690 · 📦 220K · 📋 8.5K - 19% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/scikit-learn) (📥 23M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scikit-learn) (📥 7.9M · ⏱️ 28.04.2021):
	```
...
- [GitHub](https://github.com/microsoft/LightGBM) (👨‍💻 220 · 🔀 3.2K · 📥 110K · 📦 6.8K · 📋 2.2K - 3% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/apache/spark) (👨‍💻 2.5K · 🔀 23K · 📦 580 · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/PyTorchLightning/pytorch-lightning) (👨‍💻 440 · 🔀 1.6K · 📥 3.3K · 📦 2.8K · 📋 3.2K - 6% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/PyTorchLightning/pytorch-lightning
	```
- [PyPi](https://pypi.org/project/pytorch-lightning) (📥 410K / month):
	```
...
- [GitHub](https://github.com/davisking/dlib) (👨‍💻 170 · 🔀 2.5K · 📥 25K · 📦 9.5K · 📋 1.9K - 1% open · ⏱️ 01.05.2021):
...
- [GitHub](https://github.com/explosion/thinc) (👨‍💻 38 · 🔀 200 · 📦 13K · 📋 100 - 11% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/thinc) (📥 1.9M / month):
	...
	pip install thinc
	```
- [Conda](https://anaconda.org/conda-forge/thinc) (📥 1.3M · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/apache/flink) (👨‍💻 1.3K · 🔀 8.8K · 📦 280 · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/PaddlePaddle/Paddle) (👨‍💻 540 · 🔀 3.6K · 📥 15K · 📦 40 · 📋 13K - 15% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/VowpalWabbit/vowpal_wabbit) (👨‍💻 300 · 🔀 1.6K · 📦 120 · 📋 1K - 11% open · ⏱️ 05.05.2021):
...
<details><summary><b><a href="https://github.com/google/jax">jax</a></b> (🥈29 ·  ⭐ 13K · 📈) - Composable transformations of Python+NumPy programs:.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/jax) (👨‍💻 280 · 🔀 1.1K · 📦 1.5K · 📋 2.3K - 30% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/google/jax
	```
- [PyPi](https://pypi.org/project/jax) (📥 250K / month):
	```
	pip install jax
	```
...
- [GitHub](https://github.com/deepmind/sonnet) (👨‍💻 51 · 🔀 1.2K · 📦 570 · 📋 150 - 10% open · ⏱️ 15.03.2021):
...
- [PyPi](https://pypi.org/project/dm-sonnet) (📥 83K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sonnet) (📥 9.1K · ⏱️ 14.11.2020):
	```
...
- [GitHub](https://github.com/fastai/fastai) (👨‍💻 160 · 🔀 6.9K · 📋 1.4K - 4% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/catboost/catboost) (👨‍💻 780 · 🔀 850 · 📥 55K · 📋 1.4K - 21% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/catboost) (📥 2.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/catboost) (📥 670K · ⏱️ 12.04.2021):
	```
...
- [GitHub](https://github.com/pytorch/ignite) (👨‍💻 140 · 🔀 450 · 📦 870 · 📋 800 - 11% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/google/flax) (👨‍💻 89 · 🔀 200 · 📥 23 · 📦 150 · 📋 320 - 36% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/tensorpack/tensorpack) (👨‍💻 55 · 🔀 1.7K · 📥 120 · 📦 750 · 📋 1.3K - 0% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/skorch-dev/skorch) (👨‍💻 40 · 🔀 280 · 📦 310 · 📋 380 - 11% open · ⏱️ 29.04.2021):
...
- [GitHub](https://github.com/jina-ai/jina) (👨‍💻 97 · 🔀 430 · 📦 59 · 📋 760 - 6% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/jina-ai/jina
	```
- [PyPi](https://pypi.org/project/jina) (📥 12K / month):
	```
	pip install jina
	```
- [Docker Hub](https://hub.docker.com/r/jinaai/jina) (📥 270K · ⭐ 2 · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/clab/dynet) (👨‍💻 160 · 🔀 660 · 📥 2.8K · 📦 180 · 📋 910 - 27% open · ⏱️ 27.01.2021):
...
- [GitHub](https://github.com/ludwig-ai/ludwig) (👨‍💻 91 · 🔀 860 · 📦 85 · 📋 540 - 20% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/arogozhnikov/einops) (👨‍💻 12 · 🔀 100 · 📦 490 · 📋 67 - 31% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/arogozhnikov/einops
	```
- [PyPi](https://pypi.org/project/einops) (📥 85K / month):
	```
	pip install einops
	```
...
- [GitHub](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) (👨‍💻 3.7K · 🔀 65 · 📥 16 · 📋 280 - 13% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/mlpack/mlpack) (👨‍💻 270 · 🔀 1.3K · 📋 1.3K - 6% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/mlpack/mlpack
	```
- [PyPi](https://pypi.org/project/mlpack) (📥 230 / month):
	```
	pip install mlpack
	```
...
- [GitHub](https://github.com/google/neural-tangents) (👨‍💻 18 · 🔀 160 · 📥 110 · 📦 14 · 📋 80 - 30% open · ⏱️ 21.04.2021):
...
- [GitHub](https://github.com/XiaoMi/mace) (👨‍💻 57 · 🔀 750 · 📥 1.3K · 📋 640 - 5% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/deepmind/dm-haiku) (👨‍💻 41 · 🔀 77 · 📦 85 · 📋 79 - 21% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/pytorchbearer/torchbearer) (👨‍💻 13 · 🔀 64 · 📦 43 · 📋 240 - 3% open · ⏱️ 26.03.2021):

	```
	git clone https://github.com/pytorchbearer/torchbearer
	```
- [PyPi](https://pypi.org/project/torchbearer) (📥 3.4K / month):
	```
...
- [GitHub](https://github.com/google/objax) (👨‍💻 20 · 🔀 45 · 📦 12 · 📋 89 - 40% open · ⏱️ 21.04.2021):
...
- [GitHub](https://github.com/poets-ai/elegy) (👨‍💻 13 · 🔀 11 · 📋 55 - 32% open · ⏱️ 01.04.2021):

	```
	git clone https://github.com/poets-ai/elegy
	```
- [PyPi](https://pypi.org/project/elegy) (📥 610 / month):
	```
	pip install elegy
	```
</details>
...
- [GitHub](https://github.com/neoml-lib/neoml) (👨‍💻 21 · 🔀 83 · 📋 30 - 56% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/matplotlib/matplotlib) (👨‍💻 1.2K · 🔀 5.6K · 📦 360K · 📋 7.6K - 18% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/matplotlib) (📥 20M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/matplotlib) (📥 8.8M · ⏱️ 05.05.2021):
	```
...
- [GitHub](https://github.com/plotly/dash) (👨‍💻 74 · 🔀 1.4K · 📦 20K · 📋 1K - 42% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/plotly/dash
	```
- [PyPi](https://pypi.org/project/dash) (📥 460K / month):
	```
	pip install dash
	```
...
- [GitHub](https://github.com/plotly/plotly.py) (👨‍💻 170 · 🔀 1.8K · 📦 5 · 📋 1.9K - 43% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/lmcinnes/umap) (👨‍💻 79 · 🔀 500 · 📦 2.9K · 📋 490 - 48% open · ⏱️ 03.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/umap-learn) (📥 470K / month):
	```
...
- [GitHub](https://github.com/amueller/word_cloud) (👨‍💻 61 · 🔀 2K · 📦 11K · 📋 430 - 18% open · ⏱️ 01.03.2021):
...
- [GitHub](https://github.com/ResidentMario/missingno) (👨‍💻 16 · 🔀 350 · 📦 3.6K · 📋 100 - 16% open · ⏱️ 27.04.2021):
...
- [PyPi](https://pypi.org/project/missingno) (📥 330K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/missingno) (📥 89K · ⏱️ 15.02.2020):
	```
...
- [GitHub](https://github.com/xflr6/graphviz) (👨‍💻 15 · 🔀 140 · 📦 20K · 📋 100 - 4% open · ⏱️ 01.05.2021):
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 56 · 🔀 150 · 📥 71 · 📦 320 · 📋 450 - 30% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/pyvista/pyvista
	```
- [PyPi](https://pypi.org/project/pyvista) (📥 29K / month):
	```
	pip install pyvista
	```
- [Conda](https://anaconda.org/conda-forge/pyvista) (📥 82K · ⏱️ 14.04.2021):
	```
...
- [GitHub](https://github.com/tensorflow/data-validation) (👨‍💻 20 · 🔀 96 · 📥 220 · 📦 270 · 📋 120 - 26% open · ⏱️ 27.04.2021):

	```
	git clone https://github.com/tensorflow/data-validation
	```
- [PyPi](https://pypi.org/project/tensorflow-data-validation) (📥 6.3M / month):
	```
...
- [GitHub](https://github.com/holoviz/datashader) (👨‍💻 43 · 🔀 310 · 📦 670 · 📋 470 - 25% open · ⏱️ 13.04.2021):
...
- [GitHub](https://github.com/holoviz/holoviews) (👨‍💻 100 · 🔀 310 · 📋 2.6K - 27% open · ⏱️ 21.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/holoviews) (📥 100K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/holoviews) (📥 480K · ⏱️ 08.04.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@pyviz/jupyterlab_pyviz) (📥 6.1K / month):
	```
...
- [GitHub](https://github.com/santosjorge/cufflinks) (👨‍💻 38 · 🔀 520 · 📦 3.3K · 📋 190 - 36% open · ⏱️ 25.02.2021):
...
- [GitHub](https://github.com/SauceCat/PDPbox) (👨‍💻 7 · 🔀 88 · 📦 380 · 📋 54 - 29% open · ⏱️ 14.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdpbox) (📥 75K / month):
	```
	pip install pdpbox
	```
- [Conda](https://anaconda.org/conda-forge/pdpbox) (📥 7.2K · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/holoviz/hvplot) (👨‍💻 28 · 🔀 54 · 📦 580 · 📋 360 - 34% open · ⏱️ 27.04.2021):

	```
	git clone https://github.com/holoviz/hvplot
	```
- [PyPi](https://pypi.org/project/hvplot) (📥 30K / month):
	```
	pip install hvplot
	```
- [Conda](https://anaconda.org/conda-forge/hvplot) (📥 84K · ⏱️ 04.03.2021):
	```
...
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 140K · ⏱️ 30.04.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/vispy) (📥 80 / month):
	```
	npm install vispy
	```
</details>
...
- [GitHub](https://github.com/pavlin-policar/openTSNE) (👨‍💻 10 · 🔀 83 · 📦 210 · 📋 87 - 6% open · ⏱️ 25.04.2021):
...
- [PyPi](https://pypi.org/project/opentsne) (📥 17K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/opentsne) (📥 94K · ⏱️ 26.04.2021):
	```
...
- [GitHub](https://github.com/pyqtgraph/pyqtgraph) (👨‍💻 190 · 🔀 810 · 📋 800 - 32% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/pyqtgraph/pyqtgraph
	```
- [PyPi](https://pypi.org/project/pyqtgraph) (📥 61K / month):
	```
...
- [GitHub](https://github.com/PatrikHlobil/Pandas-Bokeh) (👨‍💻 12 · 🔀 83 · 📦 170 · 📋 77 - 23% open · ⏱️ 26.04.2021):
...
- [PyPi](https://pypi.org/project/MulticoreTSNE) (📥 5.1K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/multicore-tsne) (📥 7.1K · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/fbdesignpro/sweetviz) (👨‍💻 6 · 🔀 160 · 📋 76 - 27% open · ⏱️ 01.04.2021):
...
- [GitHub](https://github.com/adamerose/PandasGUI) (👨‍💻 8 · 🔀 120 · 📦 64 · 📋 100 - 23% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/adamerose/pandasgui
	```
- [PyPi](https://pypi.org/project/pandasgui) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/joypy) (📥 13K / month):
	...
	pip install joypy
	```
- [Conda](https://anaconda.org/conda-forge/joypy) (📥 9.3K · ⏱️ 28.12.2020):
	```
...
- [GitHub](https://github.com/facebookresearch/hiplot) (👨‍💻 6 · 🔀 94 · 📦 2 · 📋 63 - 12% open · ⏱️ 27.04.2021):

	```
	git clone https://github.com/facebookresearch/hiplot
	```
- [PyPi](https://pypi.org/project/hiplot) (📥 7.7K / month):
	```
	pip install hiplot
	```
...
<details><summary><b><a href="https://github.com/JetBrains/lets-plot">lets-plot</a></b> (🥉18 ·  ⭐ 600) - An open-source plotting library for statistical data. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 15 · 🔀 20 · 📥 55 · 📦 8 · 📋 160 - 40% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/gyli/PyWaffle) (👨‍💻 6 · 🔀 67 · 📦 51 · 📋 12 - 16% open · ⏱️ 26.07.2020):
...
<details><summary><b><a href="https://github.com/AutoViML/AutoViz">AutoViz</a></b> (🥉17 ·  ⭐ 340) - Automatically Visualize any dataset, any size with a single line of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/AutoViML/AutoViz) (👨‍💻 10 · 🔀 58 · 📦 46 · 📋 24 - 16% open · ⏱️ 21.12.2020):

	```
	git clone https://github.com/AutoViML/AutoViz
	```
- [PyPi](https://pypi.org/project/autoviz) (📥 4K / month):
	```
	pip install autoviz
	```
</details>
...
<details><summary><b><a href="https://github.com/voxel51/fiftyone">FiftyOne</a></b> (🥉15 ·  ⭐ 270) - Visualize, create, and debug image and video datasets.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 11 · 🔀 25 · 📦 1 · 📋 380 - 32% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/voxel51/fiftyone
	```
- [PyPi](https://pypi.org/project/fiftyone) (📥 1.2K / month):
	```
...
- [GitHub](https://github.com/Zsailer/nx_altair) (👨‍💻 3 · 🔀 20 · 📋 9 - 55% open · ⏱️ 02.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/nx-altair) (📥 350 / month):
	```
...
- [GitHub](https://github.com/explosion/spaCy) (👨‍💻 580 · 🔀 3.3K · 📥 3K · 📦 25K · 📋 4.6K - 2% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/spacy) (📥 2M / month):
	...
	pip install spacy
	```
- [Conda](https://anaconda.org/conda-forge/spacy) (📥 1.9M · ⏱️ 24.04.2021):
	```
...
- [GitHub](https://github.com/huggingface/transformers) (👨‍💻 870 · 🔀 10K · 📥 1.3K · 📦 10K · 📋 6.7K - 5% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/huggingface/transformers
	```
- [PyPi](https://pypi.org/project/transformers) (📥 2.1M / month):
	```
	pip install transformers
	```
- [Conda](https://anaconda.org/conda-forge/transformers) (📥 38K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/nltk/nltk) (👨‍💻 400 · 🔀 2.3K · 📦 99K · 📋 1.5K - 15% open · ⏱️ 26.04.2021):
...
- [PyPi](https://pypi.org/project/nltk) (📥 12M / month):
	...
	pip install nltk
	```
- [Conda](https://anaconda.org/conda-forge/nltk) (📥 690K · ⏱️ 20.04.2021):
	```
...
- [GitHub](https://github.com/allenai/allennlp) (👨‍💻 240 · 🔀 2K · 📥 37 · 📦 1.6K · 📋 2.3K - 3% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/pytorch/fairseq) (👨‍💻 320 · 🔀 3K · 📥 120 · 📦 370 · 📋 2.7K - 28% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/google/sentencepiece) (👨‍💻 52 · 🔀 660 · 📥 13K · 📦 7.3K · 📋 440 - 7% open · ⏱️ 20.04.2021):
...
- [PyPi](https://pypi.org/project/sentencepiece) (📥 2.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sentencepiece) (📥 51K · ⏱️ 09.02.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/fastText) (👨‍💻 58 · 🔀 4.2K · 📦 1.7K · 📋 970 - 38% open · ⏱️ 18.07.2020):

	```
	git clone https://github.com/facebookresearch/fastText
	```
- [PyPi](https://pypi.org/project/fasttext) (📥 410K / month):
	```
...
- [GitHub](https://github.com/sloria/TextBlob) (👨‍💻 34 · 🔀 970 · 📥 90 · 📦 12K · 📋 230 - 34% open · ⏱️ 16.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/textblob) (📥 480K / month):
	```
...
<details><summary><b><a href="https://github.com/UKPLab/sentence-transformers">sentence-transformers</a></b> (🥇30 ·  ⭐ 5K) - Sentence Embeddings with BERT & XLNet. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/UKPLab/sentence-transformers) (👨‍💻 46 · 🔀 920 · 📦 960 · 📋 840 - 47% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/pytorch/text) (👨‍💻 110 · 🔀 600 · 📦 4.4K · 📋 550 - 41% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/flairNLP/flair) (👨‍💻 200 · 🔀 1.3K · 📦 740 · 📋 1.5K - 5% open · ⏱️ 01.05.2021):
...
- [GitHub](https://github.com/snowballstem/snowball) (👨‍💻 26 · 🔀 130 · 📦 49K · 📋 54 - 22% open · ⏱️ 11.04.2021):
...
- [GitHub](https://github.com/OpenNMT/OpenNMT-py) (👨‍💻 170 · 🔀 1.7K · 📦 86 · 📋 1.2K - 6% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 40 · 🔀 340 · 📦 32 · 📋 420 - 23% open · ⏱️ 21.04.2021):

	```
	git clone https://github.com/huggingface/tokenizers
	```
- [PyPi](https://pypi.org/project/tokenizers) (📥 2.4M / month):
	```
	pip install tokenizers
	```
- [Conda](https://anaconda.org/conda-forge/tokenizers) (📥 49K · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/LuminosoInsight/python-ftfy) (👨‍💻 17 · 🔀 98 · 📦 3.2K · 📋 110 - 9% open · ⏱️ 04.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/ftfy) (📥 900K / month):
	```
	pip install ftfy
	```
...
- [GitHub](https://github.com/facebookresearch/ParlAI) (👨‍💻 150 · 🔀 1.4K · 📦 21 · 📋 970 - 8% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/JohnSnowLabs/spark-nlp) (👨‍💻 86 · 🔀 430 · 📋 470 - 15% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/tensorflow/text) (👨‍💻 38 · 🔀 86 · 📦 630 · 📋 110 - 15% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/tensorflow/text
	```
- [PyPi](https://pypi.org/project/tensorflow-text) (📥 370K / month):
	```
...
- [GitHub](https://github.com/RasaHQ/rasa) (👨‍💻 480 · 🔀 3.4K · 📋 5.3K - 10% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 44 · 🔀 330 · 📦 49 · 📋 590 - 14% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/jamesturk/jellyfish) (👨‍💻 23 · 🔀 130 · 📦 2.3K · 📋 99 - 10% open · ⏱️ 29.04.2021):
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 15 · 🔀 200 · 📥 15K · 📦 64 · 📋 97 - 14% open · ⏱️ 18.04.2021):
...
- [GitHub](https://github.com/explosion/spacy-transformers) (👨‍💻 15 · 🔀 110 · 📦 130 · ⏱️ 20.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/spacy-transformers) (📥 34K / month):
	```
...
- [GitHub](https://github.com/WojciechMula/pyahocorasick) (👨‍💻 21 · 🔀 87 · 📦 580 · 📋 100 - 32% open · ⏱️ 27.03.2021):
...
- [GitHub](https://github.com/Ciphey/Ciphey) (👨‍💻 40 · 🔀 380 · 📋 230 - 17% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/Ciphey/Ciphey
	```
- [PyPi](https://pypi.org/project/ciphey) (📥 5.2K / month):
	```
	pip install ciphey
	```
...
- [GitHub](https://github.com/vi3k6i5/flashtext) (👨‍💻 8 · 🔀 520 · 📦 440 · 📋 93 - 47% open · ⏱️ 03.05.2020):
...
- [GitHub](https://github.com/google-research/text-to-text-transfer-transformer) (👨‍💻 37 · 🔀 450 · 📦 34 · 📋 350 - 8% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/fastnlp/fastNLP) (👨‍💻 50 · 🔀 360 · 📥 54 · 📦 31 · 📋 150 - 13% open · ⏱️ 12.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastnlp) (📥 880 / month):
	```
	pip install fastnlp
	```
</details>
...
- [GitHub](https://github.com/chartbeat-labs/textacy) (👨‍💻 30 · 🔀 220 · 📋 230 - 12% open · ⏱️ 23.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/textacy) (📥 270K / month):
	```
	pip install textacy
	```
- [Conda](https://anaconda.org/conda-forge/textacy) (📥 86K · ⏱️ 13.04.2021):
	```
...
- [GitHub](https://github.com/DerwenAI/pytextrank) (👨‍💻 13 · 🔀 280 · 📦 150 · 📋 66 - 22% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/nipunsadvilkar/pySBD) (👨‍💻 6 · 🔀 29 · 📦 140 · 📋 56 - 14% open · ⏱️ 11.02.2021):
...
- [GitHub](https://github.com/minimaxir/textgenrnn) (👨‍💻 19 · 🔀 670 · 📥 500 · 📦 840 · 📋 190 - 56% open · ⏱️ 14.07.2020):

	```
	git clone https://github.com/minimaxir/textgenrnn
	```
- [PyPi](https://pypi.org/project/textgenrnn) (📥 8.6K / month):
	```
...
- [GitHub](https://github.com/snipsco/snips-nlu) (👨‍💻 22 · 🔀 470 · 📋 250 - 20% open · ⏱️ 03.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/snips-nlu) (📥 5.2K / month):
	```
	pip install snips-nlu
	```
</details>
<details><summary><b><a href="https://github.com/huggingface/neuralcoref">neuralcoref</a></b> (🥉22 ·  ⭐ 2.3K) - Fast Coreference Resolution in spaCy with Neural Networks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/huggingface/neuralcoref) (👨‍💻 20 · 🔀 400 · 📥 200 · 📦 330 · 📋 270 - 18% open · ⏱️ 24.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/neuralcoref) (📥 7.1K / month):
	```
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 270 · 📦 680 · 📋 70 - 35% open · ⏱️ 15.07.2017):
	...
	```
- [PyPi](https://pypi.org/project/langid) (📥 760K / month):
	```
	pip install langid
	```
</details>
...
- [GitHub](https://github.com/Hironsan/anago) (👨‍💻 11 · 🔀 360 · 📦 25 · 📋 110 - 33% open · ⏱️ 01.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/anago) (📥 3.1K / month):
	```
	pip install anago
	```
</details>
...
- [GitHub](https://github.com/deepset-ai/FARM) (👨‍💻 32 · 🔀 170 · 📋 350 - 10% open · ⏱️ 30.04.2021):
...
<details><summary><b><a href="https://github.com/allenai/scispacy">SciSpacy</a></b> (🥉22 ·  ⭐ 900) - A full spaCy pipeline and models for scientific/biomedical.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/allenai/scispacy) (👨‍💻 20 · 🔀 130 · 📦 240 · 📋 180 - 14% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/Alir3z4/python-stop-words) (👨‍💻 8 · 🔀 23 · 📦 1.2K · 📋 12 - 25% open · ⏱️ 23.07.2018):
	...
	```
- [PyPi](https://pypi.org/project/stop-words) (📥 81K / month):
	```
...
- [GitHub](https://github.com/jaraco/inflect) (👨‍💻 29 · 🔀 57 · 📋 76 - 17% open · ⏱️ 23.03.2021):

	```
	git clone https://github.com/jaraco/inflect
	```
- [PyPi](https://pypi.org/project/inflect) (📥 1.8M / month):
	```
	pip install inflect
	```
...
- [GitHub](https://github.com/IntelLabs/nlp-architect) (👨‍💻 36 · 🔀 400 · 📦 7 · 📋 120 - 9% open · ⏱️ 13.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/nlp-architect) (📥 310 / month):
	```
...
- [GitHub](https://github.com/Delta-ML/delta) (👨‍💻 41 · 🔀 290 · 📋 72 - 2% open · ⏱️ 17.12.2020):
...
- [PyPi](https://pypi.org/project/delta-nlp) (📥 14 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/zh794390558/delta) (📥 12K · ⏱️ 05.05.2021):
	```
...
- [GitHub](https://github.com/awslabs/sockeye) (👨‍💻 52 · 🔀 270 · 📋 240 - 6% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/utterworks/fast-bert) (👨‍💻 34 · 🔀 310 · 📋 230 - 60% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/NVIDIA/NeMo) (👨‍💻 91 · 🔀 460 · 📥 350 · 📋 510 - 13% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/NVIDIA/NeMo
	```
- [PyPi](https://pypi.org/project/nemo-toolkit) (📥 6.3K / month):
	```
...
- [GitHub](https://github.com/BrikerMan/Kashgari) (👨‍💻 19 · 🔀 400 · 📦 30 · 📋 350 - 9% open · ⏱️ 21.03.2021):

	```
	git clone https://github.com/BrikerMan/Kashgari
	```
- [PyPi](https://pypi.org/project/kashgari-tf) (📥 150 / month):
	```
...
- [GitHub](https://github.com/IndicoDataSolutions/finetune) (👨‍💻 19 · 🔀 68 · 📦 9 · 📋 140 - 15% open · ⏱️ 19.03.2021):
...
- [GitHub](https://github.com/textpipe/textpipe) (👨‍💻 27 · 🔀 20 · 📦 7 · 📋 40 - 37% open · ⏱️ 25.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/textpipe) (📥 3.5K / month):
	```
...
- [GitHub](https://github.com/thunlp/OpenNRE) (👨‍💻 9 · 🔀 840 · 📋 310 - 8% open · ⏱️ 09.03.2021):
...
- [GitHub](https://github.com/facebookresearch/vizseq) (👨‍💻 3 · 🔀 41 · 📦 2 · 📋 14 - 42% open · ⏱️ 20.04.2021):
...
- [GitHub](https://github.com/victordibia/neuralqa) (👨‍💻 3 · 🔀 25 · 📦 2 · 📋 28 - 71% open · ⏱️ 16.12.2020):
...
<details><summary><b><a href="https://github.com/as-ideas/headliner">Headliner</a></b> (🥉13 ·  ⭐ 230 · 💀) - Easy training and deployment of seq2seq models. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/shaypal5/skift) (👨‍💻 7 · 🔀 20 · 📦 8 · 📋 10 - 20% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/skift) (📥 440 / month):
	```
	pip install skift
	```
</details>
...
- [GitHub](https://github.com/pytorch/vision) (👨‍💻 380 · 🔀 4.6K · 📦 49K · 📋 1.6K - 21% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/torchvision) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/torchvision) (📥 57K · ⏱️ 22.04.2021):
	```
...
- [GitHub](https://github.com/aleju/imgaug) (👨‍💻 36 · 🔀 2K · 📦 6.2K · 📋 440 - 52% open · ⏱️ 01.06.2020):
...
- [GitHub](https://github.com/imageio/imageio) (👨‍💻 77 · 🔀 180 · 📦 41K · 📋 360 - 20% open · ⏱️ 26.04.2021):
...
- [GitHub](https://github.com/scikit-image/scikit-image) (👨‍💻 490 · 🔀 1.7K · 📦 68K · 📋 2K - 24% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/Zulko/moviepy) (👨‍💻 140 · 🔀 1K · 📦 7.2K · 📋 1K - 27% open · ⏱️ 15.04.2021):
...
- [GitHub](https://github.com/facebookresearch/detectron2) (👨‍💻 160 · 🔀 4K · 📦 230 · 📋 2.4K - 3% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/facebookresearch/detectron2
	```
- [Conda](https://anaconda.org/conda-forge/detectron2) (📥 18K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/JohannesBuchner/imagehash) (👨‍💻 17 · 🔀 260 · 📦 2.5K · 📋 89 - 15% open · ⏱️ 03.01.2021):
...
<details><summary><b><a href="https://github.com/rwightman/pytorch-image-models">PyTorch Image Models</a></b> (🥈28 ·  ⭐ 9.4K) - PyTorch image models, scripts, pretrained weights --.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rwightman/pytorch-image-models) (👨‍💻 42 · 🔀 1.4K · 📥 350K · 📦 510 · 📋 300 - 6% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/albumentations-team/albumentations) (👨‍💻 77 · 🔀 1K · 📦 3.5K · 📋 420 - 39% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/dmlc/gluon-cv) (👨‍💻 110 · 🔀 1.1K · 📦 480 · 📋 750 - 48% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/glfw/glfw) (👨‍💻 170 · 🔀 2.6K · 📥 2.3M · 📋 1.4K - 27% open · ⏱️ 22.04.2021):
...
- [PyPi](https://pypi.org/project/glfw) (📥 46K / month):
	...
	pip install glfw
	```
- [Conda](https://anaconda.org/conda-forge/glfw) (📥 30K · ⏱️ 08.04.2021):
	```
...
- [GitHub](https://github.com/OlafenwaMoses/ImageAI) (👨‍💻 13 · 🔀 1.7K · 📥 580K · 📦 800 · 📋 600 - 31% open · ⏱️ 05.01.2021):
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥈26 ·  ⭐ 4K) - Open Source Differentiable Computer Vision Library for PyTorch. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/kornia/kornia) (👨‍💻 96 · 🔀 380 · 📦 360 · 📋 380 - 19% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/kornia/kornia
	```
- [PyPi](https://pypi.org/project/kornia) (📥 51K / month):
	```
	pip install kornia
	```
</details>
...
- [PyPi](https://pypi.org/project/imutils) (📥 240K / month):
	...
	pip install imutils
	```
- [Conda](https://anaconda.org/conda-forge/imutils) (📥 49K · ⏱️ 15.01.2021):
	```
...
- [GitHub](https://github.com/open-mmlab/mmdetection) (👨‍💻 210 · 🔀 4.7K · 📦 41 · 📋 3.7K - 6% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/timesler/facenet-pytorch) (👨‍💻 14 · 🔀 440 · 📥 91K · 📦 340 · 📋 120 - 28% open · ⏱️ 27.04.2021):
...
<details><summary><b><a href="https://github.com/deepinsight/insightface">InsightFace</a></b> (🥉24 ·  ⭐ 9.1K) - Face Analysis Project on MXNet and PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1X" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepinsight/insightface) (👨‍💻 17 · 🔀 3.1K · 📦 68 · 📋 1.4K - 50% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/deepinsight/insightface
	```
- [PyPi](https://pypi.org/project/insightface) (📥 3.5K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/pytorch3d) (👨‍💻 57 · 🔀 570 · 📦 70 · 📋 570 - 12% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/facebookresearch/pytorch3d
	```
- [PyPi](https://pypi.org/project/pytorch3d) (📥 8.6K / month):
	```
	pip install pytorch3d
	```
- [Conda](https://anaconda.org/pytorch3d/pytorch3d) (📥 9.6K · ⏱️ 09.02.2021):
	```
...
- [GitHub](https://github.com/opencv/opencv-python) (👨‍💻 28 · 🔀 360 · 📋 420 - 5% open · ⏱️ 01.05.2021):
...
- [GitHub](https://github.com/1adrianb/face-alignment) (👨‍💻 23 · 🔀 1K · 📋 240 - 13% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/face-alignment) (📥 6.6K / month):
	```
...
- [GitHub](https://github.com/ipazc/mtcnn) (👨‍💻 14 · 🔀 390 · 📦 1.1K · 📋 90 - 60% open · ⏱️ 13.01.2021):
...
- [GitHub](https://github.com/nicolas-chaulet/torch-points3d) (👨‍💻 22 · 🔀 190 · 📦 2 · 📋 230 - 22% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/facebookresearch/mmf) (👨‍💻 62 · 🔀 650 · 📦 7 · 📋 490 - 22% open · ⏱️ 06.05.2021):
...
<details><summary><b><a href="https://github.com/lucidrains/vit-pytorch">vit-pytorch</a></b> (🥉21 ·  ⭐ 4K) - Implementation of Vision Transformer, a simple way to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/lucidrains/vit-pytorch) (👨‍💻 7 · 🔀 450 · 📦 13 · 📋 95 - 40% open · ⏱️ 02.05.2021):
...
- [GitHub](https://github.com/qubvel/segmentation_models) (👨‍💻 14 · 🔀 730 · 📋 410 - 39% open · ⏱️ 17.04.2020):
...
- [GitHub](https://github.com/idealo/image-super-resolution) (👨‍💻 9 · 🔀 510 · 📦 48 · 📋 170 - 39% open · ⏱️ 11.11.2020):
...
<details><summary><b><a href="https://github.com/lightly-ai/lightly">lightly</a></b> (🥉21 ·  ⭐ 800) - A python library for self-supervised learning on images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 9 · 🔀 48 · 📦 12 · 📋 160 - 22% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/CellProfiler/CellProfiler) (👨‍💻 120 · 🔀 280 · 📥 920 · 📦 4 · 📋 3K - 5% open · ⏱️ 16.04.2021):
...
- [GitHub](https://github.com/jasmcaus/caer) (👨‍💻 6 · 🔀 38 · 📥 14 · 📋 13 - 30% open · ⏱️ 02.05.2021):
...
<details><summary><b><a href="https://github.com/PaddlePaddle/PaddleDetection">PaddleDetection</a></b> (🥉20 ·  ⭐ 3.1K) - Object detection and instance segmentation toolkit.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PaddlePaddle/PaddleDetection) (👨‍💻 55 · 🔀 800 · 📦 5 · 📋 1.5K - 20% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/facebookresearch/ClassyVision) (👨‍💻 61 · 🔀 220 · 📋 66 - 21% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/facebookresearch/ClassyVision
	```
- [PyPi](https://pypi.org/project/classy_vision) (📥 240 / month):
	```
	pip install classy_vision
	```
- [Conda](https://anaconda.org/conda-forge/classy_vision) (📥 7.3K · ⏱️ 11.12.2020):
	```
...
- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 8 · 🔀 65 · 📋 21 - 19% open · ⏱️ 16.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/norfair) (📥 800 / month):
	```
	pip install norfair
	```
</details>
...
<details><summary><b><a href="https://github.com/EdjoLabs/image-match">image-match</a></b> (🥉16 ·  ⭐ 2.6K) - Quickly search over billions of images. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/EdjoLabs/image-match) (👨‍💻 17 · 🔀 360 · 📋 93 - 48% open · ⏱️ 04.01.2021):
...
<details><summary><b><a href="https://github.com/facebookresearch/SlowFast">PySlowFast</a></b> (🥉15 ·  ⭐ 3.6K) - PySlowFast: video understanding codebase from FAIR for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/SlowFast) (👨‍💻 21 · 🔀 690 · 📦 2 · 📋 390 - 49% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/networkx/networkx) (👨‍💻 510 · 🔀 2.2K · 📥 51 · 📦 74K · 📋 2.5K - 6% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/igraph/python-igraph) (👨‍💻 50 · 🔀 180 · 📥 130K · 📦 1.6K · 📋 300 - 5% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/igraph/python-igraph
	```
- [PyPi](https://pypi.org/project/python-igraph) (📥 85K / month):
	```
...
- [GitHub](https://github.com/rusty1s/pytorch_geometric) (👨‍💻 160 · 🔀 1.8K · 📋 2K - 37% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/dmlc/dgl) (👨‍💻 120 · 🔀 1.5K · 📋 990 - 19% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/stellargraph/stellargraph) (👨‍💻 32 · 🔀 270 · 📦 62 · 📋 930 - 23% open · ⏱️ 18.02.2021):

	```
	git clone https://github.com/stellargraph/stellargraph
	```
- [PyPi](https://pypi.org/project/stellargraph) (📥 6.9K / month):
	```
	pip install stellargraph
	```
</details>
<details><summary><b><a href="https://github.com/snap-stanford/ogb">ogb</a></b> (🥈23 ·  ⭐ 920) - Benchmark datasets, data loaders, and evaluators for graph machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 15 · 🔀 170 · 📦 85 · 📋 130 - 1% open · ⏱️ 03.05.2021):
...
- [PyPi](https://pypi.org/project/pygal) (📥 110K / month):
	...
	pip install pygal
	```
- [Conda](https://anaconda.org/conda-forge/pygal) (📥 6.4K · ⏱️ 04.06.2019):
	```
...
- [GitHub](https://github.com/danielegrattarola/spektral) (👨‍💻 16 · 🔀 220 · 📦 48 · 📋 140 - 15% open · ⏱️ 24.03.2021):
...
- [GitHub](https://github.com/Accenture/AmpliGraph) (👨‍💻 14 · 🔀 160 · 📦 13 · 📋 180 - 13% open · ⏱️ 25.08.2020):
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_cluster">torch-cluster</a></b> (🥈20 ·  ⭐ 370) - PyTorch Extension Library of Optimized Graph Cluster.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_cluster) (👨‍💻 18 · 🔀 72 · 📋 79 - 49% open · ⏱️ 06.03.2021):

	```
	git clone https://github.com/rusty1s/pytorch_cluster
	```
- [PyPi](https://pypi.org/project/torch-cluster) (📥 9.9K / month):
	```
	pip install torch-cluster
	```
</details>
<details><summary><b><a href="https://github.com/pykeen/pykeen">PyKEEN</a></b> (🥉19 ·  ⭐ 400) - A Python library for learning and evaluating knowledge graph embeddings. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pykeen/pykeen) (👨‍💻 18 · 🔀 62 · 📥 79 · 📋 180 - 35% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/pykeen/pykeen
	```
- [PyPi](https://pypi.org/project/pykeen) (📥 570 / month):
	```
	pip install pykeen
	```
</details>
...
- [GitHub](https://github.com/PaddlePaddle/PGL) (👨‍💻 16 · 🔀 140 · 📦 11 · 📋 57 - 35% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/PaddlePaddle/PGL
	```
- [PyPi](https://pypi.org/project/pgl) (📥 780 / month):
	```
	pip install pgl
	```
</details>
<details><summary><b><a href="https://github.com/benedekrozemberczki/pytorch_geometric_temporal">pytorch_geometric_temporal</a></b> (🥉18 ·  ⭐ 670) - A Temporal Extension Library for PyTorch Geometric. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) (👨‍💻 9 · 🔀 86 · 📋 28 - 7% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/benedekrozemberczki/pytorch_geometric_temporal
	```
- [PyPi](https://pypi.org/project/torch-geometric-temporal) (📥 760 / month):
	```
...
- [GitHub](https://github.com/facebookresearch/PyTorch-BigGraph) (👨‍💻 21 · 🔀 370 · 📥 110 · 📋 140 - 25% open · ⏱️ 03.05.2021):
...
<details><summary><b><a href="https://github.com/IBCNServices/pyRDF2Vec">pyRDF2Vec</a></b> (🥉16 ·  ⭐ 110) - Python Implementation and Extension of RDF2Vec. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/shenweichen/GraphEmbedding) (👨‍💻 8 · 🔀 590 · 📦 7 · 📋 42 - 69% open · ⏱️ 18.10.2020):
...
<details><summary><b><a href="https://github.com/vaticle/kglib">kglib</a></b> (🥉15 ·  ⭐ 420) - Grakn Knowledge Graph Library (ML R&D). <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/deepgraph) (📥 330 / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/deepgraph) (📥 92K · ⏱️ 15.01.2021):
	```
...
- [GitHub](https://github.com/williamleif/GraphSAGE) (👨‍💻 9 · 🔀 650 · 📋 140 - 57% open · ⏱️ 19.09.2018):

	```
	git clone https://github.com/williamleif/GraphSAGE
	```
</details>
<details><summary><b><a href="https://github.com/DeepGraphLearning/graphvite">GraphVite</a></b> (🥉13 ·  ⭐ 900) - GraphVite: A General and High-performance Graph Embedding System. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/mozilla/DeepSpeech) (👨‍💻 160 · 🔀 3.1K · 📥 530K · 📦 460 · 📋 2K - 4% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/pytorch/audio) (👨‍💻 120 · 🔀 300 · 📦 2.7K · 📋 430 - 26% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/pytorch/audio
	```
- [PyPi](https://pypi.org/project/torchaudio) (📥 220K / month):
	```
...
- [GitHub](https://github.com/Uberi/speech_recognition) (👨‍💻 41 · 🔀 1.8K · 📦 8.1K · 📋 470 - 42% open · ⏱️ 02.07.2019):

	```
	git clone https://github.com/Uberi/speech_recognition
	```
- [PyPi](https://pypi.org/project/SpeechRecognition) (📥 160K / month):
	```
...
- [GitHub](https://github.com/espnet/espnet) (👨‍💻 150 · 🔀 1.1K · 📥 61 · 📦 7 · 📋 1.3K - 11% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/espnet/espnet
	```
- [PyPi](https://pypi.org/project/espnet) (📥 2.3K / month):
	```
	pip install espnet
	```
</details>
...
- [GitHub](https://github.com/bastibe/python-soundfile) (👨‍💻 19 · 🔀 43 · 📥 2.3K · 📦 6.8K · 📋 140 - 37% open · ⏱️ 01.12.2020):
...
- [GitHub](https://github.com/deezer/spleeter) (👨‍💻 17 · 🔀 1.7K · 📥 1M · 📋 540 - 15% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/MTG/essentia) (👨‍💻 71 · 🔀 410 · 📦 180 · 📋 870 - 33% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/Picovoice/porcupine) (👨‍💻 27 · 🔀 340 · 📦 5 · 📋 300 - 1% open · ⏱️ 05.05.2021):
...
<details><summary><b><a href="https://github.com/mozilla/TTS">TTS</a></b> (🥉20 ·  ⭐ 4.6K) - Deep learning for Text to Speech (Discussion forum:.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/mozilla/TTS) (👨‍💻 55 · 🔀 730 · 📥 550 · 📋 490 - 6% open · ⏱️ 12.02.2021):
...
- [GitHub](https://github.com/bmcfee/muda) (👨‍💻 7 · 🔀 33 · 📦 9 · 📋 49 - 10% open · ⏱️ 03.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/muda) (📥 260 / month):
	```
	pip install muda
	```
</details>
...
- [GitHub](https://github.com/adefossez/julius) (👨‍💻 2 · 🔀 6 · 📦 12 · ⏱️ 26.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/julius) (📥 2.8K / month):
	```
	pip install julius
	```
</details>
...
- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 160 · 🔀 1.5K · 📦 1.6K · 📋 2.1K - 3% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/visgl/deck.gl
	```
- [PyPi](https://pypi.org/project/pydeck) (📥 230K / month):
	```
	pip install pydeck
	```
- [Conda](https://anaconda.org/conda-forge/pydeck) (📥 28K · ⏱️ 13.04.2021):
	```
...
- [GitHub](https://github.com/python-visualization/folium) (👨‍💻 120 · 🔀 1.9K · 📦 9.8K · 📋 840 - 16% open · ⏱️ 09.03.2021):
...
- [GitHub](https://github.com/geopandas/geopandas) (👨‍💻 140 · 🔀 560 · 📥 1K · 📦 8.3K · 📋 1K - 27% open · ⏱️ 05.05.2021):
...
- [PyPi](https://pypi.org/project/geopandas) (📥 1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/geopandas) (📥 970K · ⏱️ 01.03.2021):
	```
...
- [GitHub](https://github.com/pyproj4/pyproj) (👨‍💻 40 · 🔀 150 · 📦 9.5K · 📋 410 - 1% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/pyproj4/pyproj
	```
- [PyPi](https://pypi.org/project/pyproj) (📥 2.5M / month):
	```
	pip install pyproj
	```
...
- [GitHub](https://github.com/Toblerity/Shapely) (👨‍💻 110 · 🔀 400 · 📦 18K · 📋 740 - 16% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/DenisCarriere/geocoder) (👨‍💻 74 · 🔀 250 · 📦 3.3K · 📋 280 - 23% open · ⏱️ 12.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/geocoder) (📥 1.3M / month):
	```
...
- [GitHub](https://github.com/mapbox/rasterio) (👨‍💻 110 · 🔀 390 · 📥 700 · 📦 3.1K · 📋 1.4K - 9% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/mapbox/rasterio
	```
- [PyPi](https://pypi.org/project/rasterio) (📥 470K / month):
	```
...
- [GitHub](https://github.com/Toblerity/Fiona) (👨‍💻 65 · 🔀 160 · 📦 5.7K · 📋 620 - 10% open · ⏱️ 25.04.2021):
...
- [GitHub](https://github.com/Esri/arcgis-python-api) (👨‍💻 62 · 🔀 730 · 📋 340 - 32% open · ⏱️ 06.05.2021):
...
<details><summary><b><a href="https://github.com/pysal/pysal">PySAL</a></b> (🥉22 ·  ⭐ 840) - PySAL: Python Spatial Analysis Library Meta-Package. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pytroll/satpy) (👨‍💻 110 · 🔀 190 · 📦 41 · 📋 580 - 44% open · ⏱️ 04.05.2021):
...
- [PyPi](https://pypi.org/project/satpy) (📥 1.4K / month):
	...
	pip install satpy
	```
- [Conda](https://anaconda.org/conda-forge/satpy) (📥 61K · ⏱️ 26.03.2021):
	```
	conda install -c conda-forge satpy
	```
</details>
<details><summary><b><a href="https://github.com/sentinelsat/sentinelsat">Sentinelsat</a></b> (🥉20 ·  ⭐ 600) - Search and download Copernicus Sentinel satellite images. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sentinelsat/sentinelsat) (👨‍💻 37 · 🔀 160 · 📥 200 · 📦 190 · 📋 260 - 8% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/earthlab/earthpy) (👨‍💻 39 · 🔀 110 · 📦 89 · 📋 220 - 7% open · ⏱️ 06.04.2021):
...
- [GitHub](https://github.com/andrea-cuttone/geoplotlib) (👨‍💻 8 · 🔀 150 · 📦 95 · 📋 42 - 57% open · ⏱️ 06.05.2019):

	```
	git clone https://github.com/andrea-cuttone/geoplotlib
	```
- [PyPi](https://pypi.org/project/geoplotlib) (📥 2K / month):
	```
...
- [GitHub](https://github.com/geospace-code/pymap3d) (👨‍💻 8 · 🔀 58 · 📋 26 - 7% open · ⏱️ 13.04.2021):

	```
	git clone https://github.com/geospace-code/pymap3d
	```
- [PyPi](https://pypi.org/project/pymap3d) (📥 42K / month):
	```
	pip install pymap3d
	```
- [Conda](https://anaconda.org/conda-forge/pymap3d) (📥 8.9K · ⏱️ 13.04.2021):
	```
...
- [GitHub](https://github.com/ranaroussi/yfinance) (👨‍💻 36 · 🔀 1.2K · 📦 4.2K · 📋 530 - 56% open · ⏱️ 25.03.2021):

	```
	git clone https://github.com/ranaroussi/yfinance
	```
- [PyPi](https://pypi.org/project/yfinance) (📥 210K / month):
	```
...
- [GitHub](https://github.com/quantopian/pyfolio) (👨‍💻 55 · 🔀 1.1K · 📦 240 · 📋 390 - 31% open · ⏱️ 15.07.2020):
...
- [GitHub](https://github.com/mementum/backtrader) (👨‍💻 51 · 🔀 1.9K · 📦 550 · ⏱️ 11.02.2021):

	```
	git clone https://github.com/mementum/backtrader
	```
- [PyPi](https://pypi.org/project/backtrader) (📥 32K / month):
	```
...
- [GitHub](https://github.com/bukosabino/ta) (👨‍💻 23 · 🔀 510 · 📦 530 · 📋 160 - 46% open · ⏱️ 29.11.2020):
...
- [GitHub](https://github.com/pmorissette/bt) (👨‍💻 21 · 🔀 270 · 📦 52 · 📋 240 - 12% open · ⏱️ 24.04.2021):
...
<details><summary><b><a href="https://github.com/quantopian/empyrical">empyrical</a></b> (🥈25 ·  ⭐ 780 · 💤) - Common financial risk and performance metrics. Used by zipline.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/quantopian/empyrical) (👨‍💻 22 · 🔀 240 · 📦 600 · 📋 49 - 46% open · ⏱️ 14.10.2020):

	```
	git clone https://github.com/quantopian/empyrical
	```
- [PyPi](https://pypi.org/project/empyrical) (📥 67K / month):
	```
...
- [GitHub](https://github.com/bashtage/arch) (👨‍💻 26 · 🔀 160 · 📦 290 · 📋 150 - 6% open · ⏱️ 22.04.2021):

	```
	git clone https://github.com/bashtage/arch
	```
- [PyPi](https://pypi.org/project/arch) (📥 67K / month):
	```
	pip install arch
	```
</details>
...
- [GitHub](https://github.com/tensortrade-org/tensortrade) (👨‍💻 50 · 🔀 700 · 📦 16 · 📋 170 - 13% open · ⏱️ 24.03.2021):
...
- [GitHub](https://github.com/peerchemist/finta) (👨‍💻 24 · 🔀 340 · 📦 73 · 📋 70 - 11% open · ⏱️ 17.04.2021):

	```
	git clone https://github.com/peerchemist/finta
	```
- [PyPi](https://pypi.org/project/finta) (📥 7.6K / month):
	```
	pip install finta
	```
</details>
...
- [GitHub](https://github.com/microsoft/qlib) (👨‍💻 39 · 🔀 780 · 📥 230 · 📦 2 · 📋 210 - 53% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 31 · 🔀 320 · 📦 4 · 📋 23 - 43% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/cuemacro/finmarketpy) (👨‍💻 14 · 🔀 410 · 📥 39 · 📦 3 · 📋 25 - 88% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/cuemacro/finmarketpy
	```
- [PyPi](https://pypi.org/project/finmarketpy) (📥 86 / month):
	```
...
- [GitHub](https://github.com/erdewit/ib_insync) (👨‍💻 28 · 🔀 420 · 📋 310 - 0% open · ⏱️ 28.04.2021):
...
- [PyPi](https://pypi.org/project/ib_insync) (📥 6.4K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ib-insync) (📥 9.4K · ⏱️ 25.02.2021):
	```
	conda install -c conda-forge ib-insync
	```
</details>
<details><summary><b><a href="https://github.com/jealous/stockstats">stockstats</a></b> (🥉20 ·  ⭐ 770 · 💤) - Supply a wrapper ``StockDataFrame`` based on the.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jealous/stockstats) (👨‍💻 7 · 🔀 210 · 📦 240 · 📋 60 - 48% open · ⏱️ 17.10.2020):
...
- [GitHub](https://github.com/CryptoSignal/Crypto-Signal) (👨‍💻 25 · 🔀 770 · 📋 230 - 16% open · ⏱️ 03.09.2020):
...
- [GitHub](https://github.com/kernc/backtesting.py) (👨‍💻 13 · 🔀 290 · 📋 220 - 12% open · ⏱️ 29.04.2021):

	```
	git clone https://github.com/kernc/backtesting.py
	```
- [PyPi](https://pypi.org/project/backtesting) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/alkaline-ml/pmdarima) (👨‍💻 17 · 🔀 160 · 📦 920 · 📋 230 - 7% open · ⏱️ 19.04.2021):

	```
	git clone https://github.com/alkaline-ml/pmdarima
	```
- [PyPi](https://pypi.org/project/pmdarima) (📥 390K / month):
	```
...
- [GitHub](https://github.com/facebook/prophet) (👨‍💻 130 · 🔀 3.6K · 📥 600 · 📋 1.6K - 4% open · ⏱️ 21.04.2021):
...
- [GitHub](https://github.com/tslearn-team/tslearn) (👨‍💻 30 · 🔀 230 · 📦 220 · 📋 230 - 27% open · ⏱️ 25.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/tslearn) (📥 60K / month):
	```
	pip install tslearn
	```
...
- [GitHub](https://github.com/blue-yonder/tsfresh) (👨‍💻 76 · 🔀 860 · 📋 460 - 7% open · ⏱️ 02.05.2021):
...
- [GitHub](https://github.com/alan-turing-institute/sktime) (👨‍💻 83 · 🔀 530 · 📥 57 · 📦 140 · 📋 400 - 23% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/alan-turing-institute/sktime
	```
- [PyPi](https://pypi.org/project/sktime) (📥 48K / month):
	```
	pip install sktime
	```
</details>
...
- [GitHub](https://github.com/awslabs/gluon-ts) (👨‍💻 71 · 🔀 390 · 📋 540 - 31% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/awslabs/gluon-ts
	```
- [PyPi](https://pypi.org/project/gluonts) (📥 34K / month):
	```
	pip install gluonts
	```
</details>
...
- [GitHub](https://github.com/TDAmeritrade/stumpy) (👨‍💻 21 · 🔀 170 · 📋 230 - 10% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/python-streamz/streamz) (👨‍💻 39 · 🔀 120 · 📦 200 · 📋 220 - 39% open · ⏱️ 05.04.2021):

	```
	git clone https://github.com/python-streamz/streamz
	```
- [PyPi](https://pypi.org/project/streamz) (📥 8.4K / month):
	```
	pip install streamz
	```
...
<details><summary><b><a href="https://github.com/jdb78/pytorch-forecasting">pytorch-forecasting</a></b> (🥉20 ·  ⭐ 970) - Time series forecasting with PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jdb78/pytorch-forecasting) (👨‍💻 17 · 🔀 120 · 📋 200 - 20% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/unit8co/darts) (👨‍💻 28 · 🔀 110 · 📦 2 · 📋 82 - 20% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/X-DataInitiative/tick) (👨‍💻 16 · 🔀 75 · 📥 160 · 📦 30 · 📋 210 - 24% open · ⏱️ 15.06.2020):
...
- [GitHub](https://github.com/dmbee/seglearn) (👨‍💻 13 · 🔀 47 · 📦 7 · 📋 27 - 18% open · ⏱️ 12.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/seglearn) (📥 2.4K / month):
	```
...
- [GitHub](https://github.com/AutoViML/Auto_TS) (👨‍💻 6 · 🔀 42 · 📋 37 - 16% open · ⏱️ 14.03.2021):
...
<details><summary><b><a href="https://github.com/firmai/atspy">atspy</a></b> (🥉12 ·  ⭐ 350) - AtsPy: Automated Time Series Models in Python (by @firmai). <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/CamDavidsonPilon/lifelines) (👨‍💻 93 · 🔀 410 · 📦 560 · 📋 800 - 24% open · ⏱️ 15.04.2021):
...
- [GitHub](https://github.com/nipy/nipype) (👨‍💻 220 · 🔀 430 · 📦 580 · 📋 1.2K - 26% open · ⏱️ 01.05.2021):
...
- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 260 · 🔀 880 · 📦 940 · 📋 3.6K - 8% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/nipy/nibabel) (👨‍💻 90 · 🔀 210 · 📦 4.3K · 📋 390 - 23% open · ⏱️ 27.04.2021):
...
- [GitHub](https://github.com/nilearn/nilearn) (👨‍💻 170 · 🔀 410 · 📦 990 · 📋 1.4K - 15% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/nilearn) (📥 27K / month):
	...
	pip install nilearn
	```
- [Conda](https://anaconda.org/conda-forge/nilearn) (📥 95K · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/hail-is/hail) (👨‍💻 73 · 🔀 180 · 📦 37 · 📋 2K - 0% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/hail-is/hail
	```
- [PyPi](https://pypi.org/project/hail) (📥 5K / month):
	```
	pip install hail
	```
</details>
...
- [GitHub](https://github.com/dipy/dipy) (👨‍💻 120 · 🔀 300 · 📦 360 · 📋 690 - 12% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/dipy) (📥 11K / month):
	...
	pip install dipy
	```
- [Conda](https://anaconda.org/conda-forge/dipy) (📥 210K · ⏱️ 06.05.2021):
	```
...
<details><summary><b><a href="https://github.com/loli/medpy">MedPy</a></b> (🥈21 ·  ⭐ 340 · 💤) - Medical image processing in Python. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/loli/medpy) (👨‍💻 13 · 🔀 110 · 📦 260 · 📋 77 - 14% open · ⏱️ 01.05.2020):
...
- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 59 · 🔀 350 · 📋 870 - 10% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/Project-MONAI/MONAI
	```
- [PyPi](https://pypi.org/project/monai) (📥 7.6K / month):
	```
	pip install monai
	```
</details>
...
- [GitHub](https://github.com/NifTK/NiftyNet) (👨‍💻 58 · 🔀 380 · 📋 320 - 30% open · ⏱️ 21.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/niftynet) (📥 200 / month):
	```
...
- [GitHub](https://github.com/projectglow/glow) (👨‍💻 12 · 🔀 44 · 📋 85 - 30% open · ⏱️ 27.04.2021):

	```
	git clone https://github.com/projectglow/glow
	```
- [PyPi](https://pypi.org/project/glow.py) (📥 13K / month):
	```
	pip install glow.py
	```
</details>
...
- [PyPi](https://pypi.org/project/brainiak) (📥 330 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/brainiak/brainiak) (📥 550 · ⭐ 1 · ⏱️ 15.10.2020):
	```
...
<details><summary><b><a href="https://github.com/MIC-DKFZ/medicaldetectiontoolkit">Medical Detection Toolkit</a></b> (🥉13 ·  ⭐ 950) - The Medical Detection Toolkit contains 2D + 3D.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PaddlePaddle/PaddleOCR) (👨‍💻 45 · 🔀 2.4K · 📦 93 · 📋 1.8K - 38% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/PaddlePaddle/PaddleOCR
	```
- [PyPi](https://pypi.org/project/paddleocr) (📥 5K / month):
	```
...
- [GitHub](https://github.com/jbarlow83/OCRmyPDF) (👨‍💻 53 · 🔀 440 · 📦 150 · 📋 700 - 12% open · ⏱️ 26.04.2021):
...
- [GitHub](https://github.com/faustomorales/keras-ocr) (👨‍💻 10 · 🔀 200 · 📥 41K · 📋 140 - 28% open · ⏱️ 31.03.2021):

	```
	git clone https://github.com/faustomorales/keras-ocr
	```
- [PyPi](https://pypi.org/project/keras-ocr) (📥 3.9K / month):
	```
...
- [GitHub](https://github.com/Calamari-OCR/calamari) (👨‍💻 17 · 🔀 170 · 📋 190 - 17% open · ⏱️ 27.03.2021):
...
- [GitHub](https://github.com/pandas-dev/pandas) (👨‍💻 2.7K · 🔀 12K · 📥 110K · 📦 440K · 📋 20K - 17% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/pandas-dev/pandas
	```
- [PyPi](https://pypi.org/project/pandas) (📥 47M / month):
	```
	pip install pandas
	```
...
- [GitHub](https://github.com/numpy/numpy) (👨‍💻 1.3K · 🔀 5.4K · 📥 340K · 📦 700K · 📋 9.5K - 21% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/numpy/numpy
	```
- [PyPi](https://pypi.org/project/numpy) (📥 72M / month):
	```
	pip install numpy
	```
...
- [GitHub](https://github.com/h5py/h5py) (👨‍💻 160 · 🔀 390 · 📥 1K · 📦 110K · 📋 1.2K - 16% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/pydata/xarray) (👨‍💻 310 · 🔀 650 · 📦 6K · 📋 2.7K - 25% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/pydata/xarray
	```
- [PyPi](https://pypi.org/project/xarray) (📥 530K / month):
	```
	pip install xarray
	```
...
- [GitHub](https://github.com/apache/arrow) (👨‍💻 670 · 🔀 1.8K · 📦 41 · 📋 600 - 1% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/databricks/koalas) (👨‍💻 50 · 🔀 300 · 📥 1K · 📦 90 · 📋 540 - 17% open · ⏱️ 03.05.2021):
...
<details><summary><b><a href="https://github.com/pydata/bottleneck">Bottleneck</a></b> (🥈28 ·  ⭐ 610) - Fast NumPy array functions written in C. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/modin-project/modin) (👨‍💻 74 · 🔀 420 · 📥 200K · 📦 350 · 📋 1.7K - 29% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/scikit-learn-contrib/sklearn-pandas) (👨‍💻 37 · 🔀 360 · 📦 2.2K · 📋 140 - 16% open · ⏱️ 27.02.2021):
...
- [GitHub](https://github.com/zarr-developers/zarr-python) (👨‍💻 40 · 🔀 110 · 📦 660 · 📋 400 - 40% open · ⏱️ 30.04.2021):
...
- [PyPi](https://pypi.org/project/zarr) (📥 100K / month):
	...
	pip install zarr
	```
- [Conda](https://anaconda.org/conda-forge/zarr) (📥 720K · ⏱️ 27.04.2021):
	```
...
- [GitHub](https://github.com/jmcarpenter2/swifter) (👨‍💻 14 · 🔀 77 · 📦 320 · 📋 96 - 20% open · ⏱️ 19.12.2020):
...
- [PyPi](https://pypi.org/project/swifter) (📥 100K / month):
	...
	pip install swifter
	```
- [Conda](https://anaconda.org/conda-forge/swifter) (📥 96K · ⏱️ 05.04.2021):
	```
...
- [GitHub](https://github.com/nalepae/pandarallel) (👨‍💻 14 · 🔀 100 · 📦 200 · 📋 120 - 55% open · ⏱️ 04.02.2021):
...
- [GitHub](https://github.com/vaexio/vaex) (👨‍💻 41 · 🔀 460 · 📥 210 · 📋 720 - 38% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/InvestmentSystems/static-frame) (👨‍💻 16 · 🔀 22 · 📦 6 · 📋 300 - 8% open · ⏱️ 30.04.2021):
...
- [PyPi](https://pypi.org/project/static-frame) (📥 1.1K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/static-frame) (📥 83K · ⏱️ 26.04.2021):
	```
...
- [GitHub](https://github.com/h2oai/datatable) (👨‍💻 28 · 🔀 100 · 📥 980 · 📋 1.3K - 10% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/h2oai/datatable
	```
- [PyPi](https://pypi.org/project/datatable) (📥 26K / month):
	```
...
- [GitHub](https://github.com/yhat/pandasql) (👨‍💻 15 · 🔀 140 · 📦 730 · 📋 63 - 63% open · ⏱️ 01.02.2017):

	```
	git clone https://github.com/yhat/pandasql
	```
- [PyPi](https://pypi.org/project/pandasql) (📥 340K / month):
	```
...
- [GitHub](https://github.com/xhochy/fletcher) (👨‍💻 24 · 🔀 31 · 📥 12 · 📦 3 · 📋 71 - 43% open · ⏱️ 18.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/fletcher) (📥 360 / month):
	```
...
<details><summary><b><a href="https://github.com/firmai/pandapy">PandaPy</a></b> (🥉10 ·  ⭐ 470) - PandaPy has the speed of NumPy and the usability of Pandas.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tensorflow/datasets) (👨‍💻 200 · 🔀 990 · 📦 4.5K · 📋 840 - 32% open · ⏱️ 06.05.2021):
...
<details><summary><b><a href="https://github.com/huggingface/datasets">Datasets</a></b> (🥈31 ·  ⭐ 8.1K · 📈) - The largest hub of ready-to-use NLP datasets for ML models with.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/datasets) (👨‍💻 260 · 🔀 870 · 📦 700 · 📋 690 - 33% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/huggingface/datasets
	```
- [PyPi](https://pypi.org/project/datasets) (📥 130K / month):
	```
	pip install datasets
	```
</details>
<details><summary><b><a href="https://github.com/martinblech/xmltodict">xmltodict</a></b> (🥈30 ·  ⭐ 4.4K · 💀) - Python module that makes working with XML feel like you are.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/snorkel-team/snorkel) (👨‍💻 64 · 🔀 730 · 📥 680 · 📦 83 · 📋 940 - 2% open · ⏱️ 13.03.2021):
...
- [GitHub](https://github.com/pydata/pandas-datareader) (👨‍💻 77 · 🔀 520 · 📦 9.2K · 📋 450 - 17% open · ⏱️ 31.12.2020):
...
- [GitHub](https://github.com/RaRe-Technologies/smart_open) (👨‍💻 80 · 🔀 270 · 📋 300 - 18% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/frictionlessdata/tabulator-py) (👨‍💻 25 · 🔀 40 · 📦 530 · 📋 180 - 0% open · ⏱️ 22.03.2021):
...
- [GitHub](https://github.com/intake/intake) (👨‍💻 60 · 🔀 100 · 📦 250 · 📋 270 - 25% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/sdv-dev/SDV) (👨‍💻 34 · 🔀 72 · 📦 21 · 📋 250 - 28% open · ⏱️ 29.04.2021):

	```
	git clone https://github.com/sdv-dev/SDV
	```
- [PyPi](https://pypi.org/project/sdv) (📥 6K / month):
	```
	pip install sdv
	```
</details>
<details><summary><b><a href="https://github.com/turicas/rows">rows</a></b> (🥉21 ·  ⭐ 740) - A common, beautiful interface to tabular data, no matter the format. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/singer-io/getting-started">Singer</a></b> (🥉18 ·  ⭐ 770) - Standard for moving data between databases, web APIs, files, queues,.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>

- [GitHub](https://github.com/singer-io/getting-started) (👨‍💻 26 · 🔀 100 · 📋 34 - 47% open · ⏱️ 29.04.2021):
...
- [GitHub](https://github.com/celery/celery) (👨‍💻 1.1K · 🔀 3.8K · 📦 52K · 📋 4.4K - 10% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/celery) (📥 5.1M / month):
	...
	pip install celery
	```
- [Conda](https://anaconda.org/conda-forge/celery) (📥 480K · ⏱️ 24.03.2021):
	```
...
- [GitHub](https://github.com/joblib/joblib) (👨‍💻 99 · 🔀 280 · 📦 99K · 📋 620 - 42% open · ⏱️ 02.04.2021):
...
- [GitHub](https://github.com/apache/airflow) (👨‍💻 1.9K · 🔀 8.1K · 📥 120K · 📋 3.2K - 24% open · ⏱️ 06.05.2021):
...
- [Conda](https://anaconda.org/conda-forge/airflow) (📥 320K · ⏱️ 20.04.2021):
	...
	```
- [Docker Hub](https://hub.docker.com/r/apache/airflow) (📥 19M · ⭐ 240 · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/apache/beam) (👨‍💻 1.1K · 🔀 2.9K · ⏱️ 06.05.2021):

	```
	git clone https://github.com/apache/beam
	```
- [PyPi](https://pypi.org/project/apache-beam) (📥 2.7M / month):
	```
...
- [GitHub](https://github.com/fishtown-analytics/dbt) (👨‍💻 150 · 🔀 560 · 📦 260 · 📋 1.9K - 17% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/dagster-io/dagster) (👨‍💻 130 · 🔀 350 · 📦 160 · 📋 2.9K - 19% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/dagster-io/dagster
	```
- [PyPi](https://pypi.org/project/dagster) (📥 52K / month):
	```
	pip install dagster
	```
- [Conda](https://anaconda.org/conda-forge/dagster) (📥 230K · ⏱️ 02.05.2021):
	```
...
- [GitHub](https://github.com/quantumblacklabs/kedro) (👨‍💻 100 · 🔀 440 · 📦 460 · 📋 460 - 8% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/quantumblacklabs/kedro
	```
- [PyPi](https://pypi.org/project/kedro) (📥 140K / month):
	```
	pip install kedro
	```
</details>
...
- [GitHub](https://github.com/EntilZha/PyFunctional) (👨‍💻 23 · 🔀 98 · 📦 280 · 📋 120 - 2% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyfunctional) (📥 67K / month):
	```
...
- [GitHub](https://github.com/petl-developers/petl) (👨‍💻 46 · 🔀 150 · 📦 390 · 📋 410 - 16% open · ⏱️ 17.04.2021):
...
- [GitHub](https://github.com/activeloopai/Hub) (👨‍💻 76 · 🔀 240 · 📦 120 · 📋 250 - 5% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/tensorflow/tfx) (👨‍💻 110 · 🔀 430 · 📋 570 - 36% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/great-expectations/great_expectations) (👨‍💻 190 · 🔀 530 · 📋 830 - 22% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/great-expectations/great_expectations
	```
- [PyPi](https://pypi.org/project/great_expectations) (📥 680K / month):
	```
...
- [GitHub](https://github.com/mara/mara-pipelines) (👨‍💻 16 · 🔀 76 · 📦 7 · 📋 18 - 33% open · ⏱️ 08.03.2021):
...
- [GitHub](https://github.com/ploomber/ploomber) (👨‍💻 4 · 🔀 4 · 📦 13 · 📋 290 - 13% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/analysiscenter/batchflow) (👨‍💻 29 · 🔀 35 · 📋 99 - 35% open · ⏱️ 22.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/batchflow) (📥 82 / month):
	```
...
- [GitHub](https://github.com/maiot-io/zenml) (👨‍💻 11 · 🔀 57 · 📦 1 · 📋 35 - 20% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/maiot-io/zenml
	```
- [PyPi](https://pypi.org/project/zenml) (📥 440 / month):
	```
	pip install zenml
	```
</details>
...
- [GitHub](https://github.com/olirice/flupy) (👨‍💻 4 · 🔀 9 · ⏱️ 09.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/flupy) (📥 27K / month):
	```
	pip install flupy
	```
</details>
...
<details><summary><b><a href="https://github.com/bodywork-ml/bodywork-core">bodywork-core</a></b> (🥉11 ·  ⭐ 210 · 🐣) - MLOps tool for deploying machine learning projects to.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>

- [GitHub](https://github.com/bodywork-ml/bodywork-core) (👨‍💻 4 · 🔀 10 · 📦 2 · 📋 24 - 29% open · ⏱️ 25.04.2021):
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 480 · 🔀 2.5K · 📦 2K · 📋 6.6K - 20% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 240 · 🔀 510 · 📦 18K · 📋 2K - 33% open · ⏱️ 06.05.2021):
...
<details><summary><b><a href="https://github.com/horovod/horovod">horovod</a></b> (🥈26 ·  ⭐ 11K) - Distributed training framework for TensorFlow, Keras, PyTorch,.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/horovod/horovod) (👨‍💻 120 · 🔀 1.8K · 📦 360 · 📋 1.8K - 12% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/tensorflow/mesh) (👨‍💻 42 · 🔀 160 · 📦 520 · 📋 68 - 80% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/microsoft/DeepSpeed) (👨‍💻 51 · 🔀 450 · 📦 29 · 📋 450 - 44% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/uber/petastorm) (👨‍💻 38 · 🔀 190 · 📥 290 · 📦 30 · 📋 230 - 50% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/uber/petastorm
	```
- [PyPi](https://pypi.org/project/petastorm) (📥 98K / month):
	```
...
- [GitHub](https://github.com/intel-analytics/analytics-zoo) (👨‍💻 90 · 🔀 640 · 📦 2 · 📋 980 - 36% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/facebookresearch/fairscale) (👨‍💻 30 · 🔀 75 · 📦 16 · 📋 170 - 26% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/dask/dask-ml) (👨‍💻 64 · 🔀 190 · 📦 380 · 📋 390 - 43% open · ⏱️ 17.04.2021):
...
- [GitHub](https://github.com/Azure/mmlspark) (👨‍💻 65 · 🔀 490 · 📋 400 - 42% open · ⏱️ 03.05.2021):
...
<details><summary><b><a href="https://github.com/facebookincubator/submitit">Submit it</a></b> (🥉21 ·  ⭐ 360) - Python 3.6+ toolbox for submitting jobs to Slurm. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookincubator/submitit) (👨‍💻 11 · 🔀 23 · 📦 130 · 📋 33 - 30% open · ⏱️ 01.04.2021):

	```
	git clone https://github.com/facebookincubator/submitit
	```
- [PyPi](https://pypi.org/project/submitit) (📥 4.8K / month):
	```
	pip install submitit
	```
- [Conda](https://anaconda.org/conda-forge/submitit) (📥 2.5K · ⏱️ 10.02.2021):
	```
...
- [GitHub](https://github.com/databricks/tensorframes) (👨‍💻 16 · 🔀 160 · 📋 91 - 52% open · ⏱️ 15.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/tensorframes) (📥 12K / month):
	```
...
- [GitHub](https://github.com/mpi4py/mpi4py) (👨‍💻 16 · 🔀 66 · 📥 1K · 📋 26 - 26% open · ⏱️ 04.05.2021):
...
- [PyPi](https://pypi.org/project/mpi4py) (📥 300K / month):
	...
	pip install mpi4py
	```
- [Conda](https://anaconda.org/conda-forge/mpi4py) (📥 620K · ⏱️ 29.04.2021):
	```
...
- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 16 · 🔀 40 · 📦 2 · 📋 71 - 49% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/learning-at-home/hivemind
	```
- [PyPi](https://pypi.org/project/hivemind) (📥 160 / month):
	```
...
- [GitHub](https://github.com/uber/fiber) (👨‍💻 5 · 🔀 95 · 📦 27 · 📋 21 - 61% open · ⏱️ 15.03.2021):
...
<details><summary><b><a href="https://github.com/ml-tooling/lazycluster">LazyCluster</a></b> (🥉13 ·  ⭐ 38) - Distributed machine learning made simple. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/ml-tooling/lazycluster) (👨‍💻 2 · 🔀 6 · 📦 3 · ⏱️ 14.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/lazycluster) (📥 140 / month):
	```
...
- [GitHub](https://github.com/optuna/optuna) (👨‍💻 130 · 🔀 500 · 📦 1.2K · 📋 760 - 18% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/scikit-optimize/scikit-optimize) (👨‍💻 72 · 🔀 380 · 📦 1.6K · 📋 550 - 32% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/scikit-optimize/scikit-optimize
	```
- [PyPi](https://pypi.org/project/scikit-optimize) (📥 1.5M / month):
	```
...
- [GitHub](https://github.com/EpistasisLab/tpot) (👨‍💻 110 · 🔀 1.4K · 📦 960 · 📋 810 - 26% open · ⏱️ 06.01.2021):
...
- [GitHub](https://github.com/fmfn/BayesianOptimization) (👨‍💻 27 · 🔀 1.1K · 📥 54 · 📦 720 · 📋 200 - 18% open · ⏱️ 19.12.2020):

	```
	git clone https://github.com/fmfn/BayesianOptimization
	```
- [PyPi](https://pypi.org/project/bayesian-optimization) (📥 99K / month):
	```
...
- [GitHub](https://github.com/microsoft/nni) (👨‍💻 130 · 🔀 1.3K · 📦 110 · 📋 1.2K - 20% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/microsoft/nni
	```
- [PyPi](https://pypi.org/project/nni) (📥 3.3K / month):
	```
	pip install nni
	```
</details>
...
- [GitHub](https://github.com/hyperopt/hyperopt) (👨‍💻 87 · 🔀 760 · 📦 3.2K · 📋 570 - 60% open · ⏱️ 24.03.2021):

	```
	git clone https://github.com/hyperopt/hyperopt
	```
- [PyPi](https://pypi.org/project/hyperopt) (📥 880K / month):
	```
...
- [GitHub](https://github.com/keras-team/keras-tuner) (👨‍💻 35 · 🔀 280 · 📦 550 · 📋 300 - 48% open · ⏱️ 06.04.2021):
...
- [GitHub](https://github.com/facebook/Ax) (👨‍💻 96 · 🔀 150 · 📦 160 · 📋 240 - 6% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/alteryx/featuretools) (👨‍💻 49 · 🔀 700 · 📦 730 · 📋 540 - 20% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/awslabs/autogluon) (👨‍💻 57 · 🔀 400 · 📦 50 · 📋 440 - 21% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/pytorch/botorch) (👨‍💻 53 · 🔀 200 · 📦 110 · 📋 170 - 21% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/pytorch/botorch
	```
- [PyPi](https://pypi.org/project/botorch) (📥 53K / month):
	```
	pip install botorch
	```
</details>
...
- [GitHub](https://github.com/automl/auto-sklearn) (👨‍💻 66 · 🔀 990 · 📦 160 · 📋 710 - 13% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/facebookresearch/nevergrad) (👨‍💻 42 · 🔀 280 · 📦 160 · 📋 190 - 31% open · ⏱️ 26.04.2021):
...
- [PyPi](https://pypi.org/project/nevergrad) (📥 26K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nevergrad) (📥 8.3K · ⏱️ 14.12.2020):
	```
...
<details><summary><b><a href="https://github.com/mljar/mljar-supervised">mljar-supervised</a></b> (🥈23 ·  ⭐ 1.2K) - Automated Machine Learning Pipeline with Feature Engineering.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mljar/mljar-supervised) (👨‍💻 9 · 🔀 160 · 📦 10 · 📋 360 - 8% open · ⏱️ 29.04.2021):

	```
	git clone https://github.com/mljar/mljar-supervised
	```
- [PyPi](https://pypi.org/project/mljar-supervised) (📥 4.4K / month):
	```
...
- [GitHub](https://github.com/AxeldeRomblay/MLBox) (👨‍💻 9 · 🔀 250 · 📦 24 · 📋 86 - 15% open · ⏱️ 25.08.2020):
...
- [GitHub](https://github.com/Neuraxio/Neuraxle) (👨‍💻 7 · 🔀 43 · 📦 18 · 📋 280 - 45% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/Epistimio/orion) (👨‍💻 23 · 🔀 38 · 📦 40 · 📋 160 - 26% open · ⏱️ 24.04.2021):
...
- [GitHub](https://github.com/AutoViML/Auto_ViML) (👨‍💻 6 · 🔀 53 · 📦 13 · 📋 18 - 22% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/williamFalcon/test-tube) (👨‍💻 16 · 🔀 60 · 📥 8 · 📋 44 - 52% open · ⏱️ 17.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/test_tube) (📥 17K / month):
	```
...
<details><summary><b><a href="https://github.com/ScottfreeLLC/AlphaPy">AlphaPy</a></b> (🥉15 ·  ⭐ 580) - Automated Machine Learning [AutoML] with Python, scikit-learn, Keras,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/shankarpandala/lazypredict">lazypredict</a></b> (🥉15 ·  ⭐ 3 · 📉) - Lazy Predict help build a lot of basic models without much.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/shankarpandala/lazypredict) (👨‍💻 12 · 🔀 1 · 📦 62 · 📋 47 - 36% open · ⏱️ 10.04.2021):

	```
	git clone https://github.com/shankarpandala/lazypredict
	```
- [PyPi](https://pypi.org/project/lazypredict) (📥 4.1K / month):
	```
...
<details><summary><b><a href="https://github.com/AutoViML/featurewiz">featurewiz</a></b> (🥉11 ·  ⭐ 52 · 🐣) - Use advanced feature engineering strategies and select the.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/AutoViML/featurewiz) (🔀 15 · ⏱️ 29.04.2021):

	```
	git clone https://github.com/AutoViML/featurewiz
	```
- [PyPi](https://pypi.org/project/featurewiz) (📥 640 / month):
	```
...
<details><summary><b><a href="https://github.com/openai/baselines">baselines</a></b> (🥇25 ·  ⭐ 11K · 💀) - OpenAI Baselines: high-quality implementations of reinforcement.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/openai/baselines) (👨‍💻 110 · 🔀 3.2K · 📦 300 · 📋 810 - 47% open · ⏱️ 31.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/baselines) (📥 12K / month):
	```
...
- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 94 · 🔀 480 · 📦 450 · 📋 450 - 21% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/google/dopamine) (👨‍💻 14 · 🔀 1.2K · 📋 140 - 46% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/google/dopamine
	```
- [PyPi](https://pypi.org/project/dopamine-rl) (📥 890K / month):
	```
...
- [GitHub](https://github.com/tensorforce/tensorforce) (👨‍💻 76 · 🔀 480 · 📋 570 - 2% open · ⏱️ 02.05.2021):
...
- [GitHub](https://github.com/deepmind/acme) (👨‍💻 38 · 🔀 220 · 📦 27 · 📋 93 - 46% open · ⏱️ 29.04.2021):
...
- [GitHub](https://github.com/chainer/chainerrl) (👨‍💻 29 · 🔀 210 · 📦 97 · 📋 200 - 25% open · ⏱️ 17.04.2021):
...
- [GitHub](https://github.com/tensorlayer/tensorlayer) (👨‍💻 130 · 🔀 1.5K · 📥 1.3K · 📋 450 - 3% open · ⏱️ 17.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/tensorlayer) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/rlworkgroup/garage) (👨‍💻 75 · 🔀 220 · 📦 17 · 📋 960 - 18% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/pfnet/pfrl) (👨‍💻 13 · 🔀 69 · 📦 8 · 📋 43 - 41% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/deepmind/lab) (👨‍💻 7 · 🔀 1.3K · 📋 190 - 19% open · ⏱️ 04.03.2021):
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 96 · 🔀 390 · 📋 95 - 21% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/deepmind/rlax) (👨‍💻 11 · 🔀 47 · 📦 16 · 📋 7 - 42% open · ⏱️ 13.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/rlax) (📥 410 / month):
	```
	pip install rlax
	```
</details>
...
<details><summary><b><a href="https://github.com/PreferredAI/cornac">Cornac</a></b> (🥈23 ·  ⭐ 330) - A Comparative Framework for Multimodal Recommender Systems. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 11 · 🔀 65 · 📦 41 · ⏱️ 24.04.2021):

	```
	git clone https://github.com/PreferredAI/cornac
	```
- [PyPi](https://pypi.org/project/cornac) (📥 2.5K / month):
	```
	pip install cornac
	```
...
<details><summary><b><a href="https://github.com/microsoft/recommenders">Recommenders</a></b> (🥉22 ·  ⭐ 9.6K) - Best Practices on Recommendation Systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/RUCAIBox/RecBole">RecBole</a></b> (🥉21 ·  ⭐ 930) - A unified, comprehensive and efficient recommendation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/RUCAIBox/RecBole) (👨‍💻 39 · 🔀 150 · 📋 110 - 23% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/RUCAIBox/RecBole
	```
- [PyPi](https://pypi.org/project/recbole) (📥 590 / month):
	```
	pip install recbole
	```
- [Conda](https://anaconda.org/aibox/recbole) (📥 380 · ⏱️ 22.03.2021):
	```
	conda install -c aibox recbole
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/recommenders">TF Recommenders</a></b> (🥉21 ·  ⭐ 810) - TensorFlow Recommenders is a library for building.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/recommenders) (👨‍💻 21 · 🔀 97 · 📦 20 · 📋 120 - 47% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/statisticianinstilettos/recmetrics) (👨‍💻 12 · 🔀 61 · 📦 19 · 📋 11 - 36% open · ⏱️ 03.12.2020):
...
<details><summary><b><a href="https://github.com/OpenMined/PySyft">PySyft</a></b> (🥇24 ·  ⭐ 7.1K) - A library for answering questions using data you cannot see. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/OpenMined/PySyft) (👨‍💻 370 · 🔀 1.6K · 📋 2.9K - 5% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/pytorch/opacus) (👨‍💻 29 · 🔀 120 · 📥 31 · 📦 29 · 📋 74 - 13% open · ⏱️ 27.04.2021):

	```
	git clone https://github.com/pytorch/opacus
	```
- [PyPi](https://pypi.org/project/opacus) (📥 6.7K / month):
	```
	pip install opacus
	```
</details>
...
- [GitHub](https://github.com/tensorflow/privacy) (👨‍💻 36 · 🔀 280 · 📥 42 · 📋 130 - 37% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/FederatedAI/FATE) (👨‍💻 56 · 🔀 880 · 📋 840 - 34% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/FederatedAI/FATE
	```
</details>
<details><summary><b><a href="https://github.com/tf-encrypted/tf-encrypted">TFEncrypted</a></b> (🥉19 ·  ⭐ 860 · 💤) - A Framework for Encrypted Machine Learning in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tf-encrypted/tf-encrypted) (👨‍💻 28 · 🔀 140 · 📦 50 · 📋 400 - 41% open · ⏱️ 19.08.2020):
...
- [GitHub](https://github.com/facebookresearch/CrypTen) (👨‍💻 23 · 🔀 110 · 📦 7 · 📋 57 - 26% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 260 · 🔀 1.3K · 📦 63K · 📋 1.5K - 34% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/iterative/dvc) (👨‍💻 220 · 🔀 730 · 📥 24K · 📦 940 · 📋 2.9K - 15% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/dvc) (📥 150K / month):
	...
	pip install dvc
	```
- [Conda](https://anaconda.org/conda-forge/dvc) (📥 640K · ⏱️ 03.05.2021):
	```
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 200 · 🔀 600 · 📦 690 · 📋 800 - 31% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/aws/sagemaker-python-sdk
	```
- [PyPi](https://pypi.org/project/sagemaker) (📥 750K / month):
	```
	pip install sagemaker
	```
</details>
<details><summary><b><a href="https://github.com/mlflow/mlflow">mlflow</a></b> (🥇30 ·  ⭐ 9.3K) - Open source platform for the machine learning lifecycle. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 290 · 🔀 1.9K · 📋 1.7K - 35% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/mlflow) (📥 4.7M / month):
	...
	pip install mlflow
	```
- [Conda](https://anaconda.org/conda-forge/mlflow) (📥 300K · ⏱️ 27.04.2021):
	```
...
- [GitHub](https://github.com/wandb/client) (👨‍💻 80 · 🔀 210 · 📦 2.8K · 📋 1K - 22% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/wandb/client
	```
- [PyPi](https://pypi.org/project/wandb) (📥 390K / month):
	```
	pip install wandb
	```
</details>
...
- [GitHub](https://github.com/IDSIA/sacred) (👨‍💻 92 · 🔀 320 · 📦 900 · 📋 490 - 18% open · ⏱️ 27.04.2021):
...
<details><summary><b><a href="https://github.com/pycaret/pycaret">PyCaret</a></b> (🥈28 ·  ⭐ 3.4K) - An open-source, low-code machine learning library in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pycaret/pycaret) (👨‍💻 50 · 🔀 730 · 📥 390 · 📦 890 · 📋 850 - 23% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/pycaret/pycaret
	```
- [PyPi](https://pypi.org/project/pycaret) (📥 64K / month):
	```
	pip install pycaret
	```
</details>
<details><summary><b><a href="https://github.com/snakemake/snakemake">snakemake</a></b> (🥈28 ·  ⭐ 960) - This is the development home of the workflow management system.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 200 · 🔀 210 · 📦 800 · 📋 610 - 62% open · ⏱️ 29.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/snakemake) (📥 24K / month):
	```
	pip install snakemake
	```
- [Conda](https://anaconda.org/bioconda/snakemake) (📥 290K · ⏱️ 05.05.2021):
	```
...
- [GitHub](https://github.com/Kaggle/kaggle-api) (👨‍💻 36 · 🔀 800 · 📦 5.3K · 📋 280 - 57% open · ⏱️ 15.03.2021):
...
- [PyPi](https://pypi.org/project/kaggle) (📥 180K / month):
	...
	pip install kaggle
	```
- [Conda](https://anaconda.org/conda-forge/kaggle) (📥 55K · ⏱️ 16.03.2021):
	```
...
- [GitHub](https://github.com/catalyst-team/catalyst) (👨‍💻 86 · 🔀 300 · 📦 340 · 📋 300 - 4% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 31 · 🔀 350 · 📦 130 · 📋 270 - 42% open · ⏱️ 05.05.2021):
...
- [PyPi](https://pypi.org/project/metaflow) (📥 47K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/metaflow) (📥 15K · ⏱️ 01.05.2021):
	```
...
- [GitHub](https://github.com/allegroai/clearml) (👨‍💻 28 · 🔀 340 · 📥 300 · 📦 31 · 📋 300 - 27% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/allegroai/clearml
	```
- [PyPi](https://pypi.org/project/clearml) (📥 18K / month):
	```
	pip install clearml
	```
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 29 · 🔀 540 · 📥 110 · 📦 280 · 📋 350 - 8% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/Azure/MachineLearningNotebooks) (👨‍💻 56 · 🔀 1.6K · 📥 410 · 📋 1.1K - 13% open · ⏱️ 19.04.2021):

	```
	git clone https://github.com/Azure/MachineLearningNotebooks
	```
- [PyPi](https://pypi.org/project/azureml-sdk) (📥 690K / month):
	```
...
- [GitHub](https://github.com/google/ml-metadata) (👨‍💻 12 · 🔀 57 · 📥 1.3K · 📦 110 · 📋 63 - 30% open · ⏱️ 04.05.2021):
...
- [GitHub](https://github.com/studioml/studio) (👨‍💻 21 · 🔀 50 · 📦 4 · 📋 250 - 22% open · ⏱️ 02.05.2021):

	```
	git clone https://github.com/studioml/studio
	```
- [PyPi](https://pypi.org/project/studioml) (📥 1.9K / month):
	```
...
- [GitHub](https://github.com/huggingface/knockknock) (👨‍💻 18 · 🔀 160 · 📦 160 · 📋 33 - 36% open · ⏱️ 16.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/knockknock) (📥 3.7K / month):
	```
	pip install knockknock
	```
- [Conda](https://anaconda.org/conda-forge/knockknock) (📥 6.4K · ⏱️ 17.03.2020):
	```
...
- [GitHub](https://github.com/instacart/lore) (👨‍💻 22 · 🔀 120 · 📦 16 · 📋 33 - 45% open · ⏱️ 11.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/lore) (📥 800 / month):
	```
	pip install lore
	```
</details>
...
- [GitHub](https://github.com/waleedka/hiddenlayer) (👨‍💻 6 · 🔀 200 · 📦 69 · 📋 77 - 57% open · ⏱️ 24.04.2020):
...
- [GitHub](https://github.com/guildai/guildai) (👨‍💻 16 · 🔀 41 · 📦 28 · 📋 270 - 37% open · ⏱️ 12.04.2021):
...
- [GitHub](https://github.com/m3dev/gokart) (👨‍💻 25 · 🔀 31 · 📋 36 - 5% open · ⏱️ 27.04.2021):

	```
	git clone https://github.com/m3dev/gokart
	```
- [PyPi](https://pypi.org/project/gokart) (📥 810 / month):
	```
	pip install gokart
	```
</details>
...
- [GitHub](https://github.com/TeamHG-Memex/tensorboard_logger) (👨‍💻 5 · 🔀 52 · 📋 23 - 34% open · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/tensorboard_logger) (📥 71K / month):
	```
	pip install tensorboard_logger
	```
</details>
<details><summary><b><a href="https://github.com/lab-ml/labml">Labml</a></b> (🥉17 ·  ⭐ 550) - Monitor deep learning model training and hardware usage from your mobile.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lab-ml/labml) (👨‍💻 6 · 🔀 39 · 📦 24 · 📋 10 - 40% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/MrPowers/quinn) (👨‍💻 6 · 🔀 28 · 📋 23 - 60% open · ⏱️ 09.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/quinn) (📥 220K / month):
	```
	pip install quinn
	```
</details>
...
- [GitHub](https://github.com/aimhubio/aim) (👨‍💻 10 · 🔀 58 · 📋 180 - 60% open · ⏱️ 20.04.2021):

	```
	git clone https://github.com/aimhubio/aim
	```
- [PyPi](https://pypi.org/project/aim) (📥 3.4K / month):
	```
	pip install aim
	```
</details>
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 200 · 🔀 1.8K · 📥 13K · 📦 3K · 📋 1.5K - 30% open · ⏱️ 04.05.2021):
...
- [PyPi](https://pypi.org/project/onnx) (📥 1.3M / month):
	...
	pip install onnx
	```
- [Conda](https://anaconda.org/conda-forge/onnx) (📥 230K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/apple/coremltools) (👨‍💻 110 · 🔀 340 · 📥 2.6K · 📦 510 · 📋 700 - 49% open · ⏱️ 30.04.2021):
...
<details><summary><b><a href="https://github.com/pytorch/serve">TorchServe</a></b> (🥈26 ·  ⭐ 1.8K) - Model Serving on PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytorch/serve) (👨‍💻 68 · 🔀 270 · 📥 210 · 📦 42 · 📋 540 - 19% open · ⏱️ 30.04.2021):
...
- [PyPi](https://pypi.org/project/torchserve) (📥 9K / month):
	...
	```
- [Conda](https://anaconda.org/pytorch/torchserve) (📥 8.1K · ⏱️ 18.03.2021):
	```
...
- [GitHub](https://github.com/cortexlabs/cortex) (👨‍💻 21 · 🔀 560 · 📋 1K - 12% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/microsoft/MMdnn) (👨‍💻 85 · 🔀 940 · 📥 3.4K · 📦 52 · 📋 600 - 51% open · ⏱️ 14.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/mmdnn) (📥 940 / month):
	```
	pip install mmdnn
	```
</details>
...
- [GitHub](https://github.com/BayesWitnesses/m2cgen) (👨‍💻 12 · 🔀 150 · 📦 6 · 📋 70 - 38% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/microsoft/hummingbird) (👨‍💻 20 · 🔀 170 · 📥 100 · 📦 15 · 📋 200 - 22% open · ⏱️ 29.04.2021):
...
- [GitHub](https://github.com/larq/compute-engine) (👨‍💻 15 · 🔀 22 · 📥 210 · 📦 2 · 📋 120 - 20% open · ⏱️ 26.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/larq-compute-engine) (📥 3.8K / month):
	```
	pip install larq-compute-engine
	```
</details>
<details><summary><b><a href="https://github.com/catmanifold/pytorch2keras">pytorch2keras</a></b> (🥉17 ·  ⭐ 700) - PyTorch to Keras model convertor. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/catmanifold/pytorch2keras) (👨‍💻 12 · 🔀 110 · 📦 20 · 📋 110 - 40% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/nok/sklearn-porter) (👨‍💻 11 · 🔀 130 · 📋 65 - 55% open · ⏱️ 18.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-porter) (📥 1K / month):
	```
...
- [PyPi](https://pypi.org/project/shap) (📥 2.8M / month):
	...
	pip install shap
	```
- [Conda](https://anaconda.org/conda-forge/shap) (📥 480K · ⏱️ 29.04.2021):
	```
...
<details><summary><b><a href="https://github.com/marcotcr/lime">Lime</a></b> (🥇28 ·  ⭐ 8.7K) - Lime: Explaining the predictions of any machine learning classifier. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/marcotcr/lime) (👨‍💻 57 · 🔀 1.4K · 📦 1.2K · 📋 500 - 11% open · ⏱️ 12.01.2021):
...
- [GitHub](https://github.com/interpretml/interpret) (👨‍💻 23 · 🔀 450 · 📦 76 · 📋 190 - 33% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/interpretml/interpret
	```
- [PyPi](https://pypi.org/project/interpret) (📥 24K / month):
	```
...
- [GitHub](https://github.com/pytorch/captum) (👨‍💻 70 · 🔀 240 · 📦 160 · 📋 220 - 20% open · ⏱️ 23.04.2021):

	```
	git clone https://github.com/pytorch/captum
	```
- [PyPi](https://pypi.org/project/captum) (📥 21K / month):
	```
	pip install captum
	```
</details>
...
- [GitHub](https://github.com/Trusted-AI/AIF360) (👨‍💻 43 · 🔀 430 · 📦 86 · 📋 91 - 41% open · ⏱️ 10.03.2021):
...
- [GitHub](https://github.com/reiinakano/scikit-plot) (👨‍💻 13 · 🔀 250 · 📦 920 · 📋 57 - 31% open · ⏱️ 19.08.2018):
...
- [PyPi](https://pypi.org/project/scikit-plot) (📥 130K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scikit-plot) (📥 88K · ⏱️ 05.06.2019):
	```
...
- [GitHub](https://github.com/tensorflow/model-analysis) (👨‍💻 35 · 🔀 200 · 📋 55 - 32% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/tensorflow/model-analysis
	```
- [PyPi](https://pypi.org/project/tensorflow-model-analysis) (📥 5.9M / month):
	```
...
- [GitHub](https://github.com/arviz-devs/arviz) (👨‍💻 79 · 🔀 210 · 📥 98 · 📦 850 · 📋 590 - 19% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/microsoft/dowhy) (👨‍💻 41 · 🔀 420 · 📥 23 · 📦 36 · 📋 120 - 20% open · ⏱️ 29.04.2021):

	```
	git clone https://github.com/Microsoft/dowhy
	```
- [PyPi](https://pypi.org/project/dowhy) (📥 24K / month):
	```
	pip install dowhy
	```
- [Conda](https://anaconda.org/conda-forge/dowhy) (📥 1.8K · ⏱️ 28.04.2021):
	```
...
- [GitHub](https://github.com/raghakot/keras-vis) (👨‍💻 10 · 🔀 590 · 📦 950 · 📋 210 - 53% open · ⏱️ 20.04.2020):
...
<details><summary><b><a href="https://github.com/SeldonIO/alibi">Alibi</a></b> (🥈23 ·  ⭐ 980) - Algorithms for monitoring and explaining machine learning models. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/SeldonIO/alibi) (👨‍💻 13 · 🔀 120 · 📦 79 · 📋 170 - 45% open · ⏱️ 29.04.2021):
...
- [GitHub](https://github.com/philipperemy/keract) (👨‍💻 15 · 🔀 180 · 📦 76 · 📋 79 - 3% open · ⏱️ 30.04.2021):
...
- [PyPi](https://pypi.org/project/eli5) (📥 500K / month):
	...
	pip install eli5
	```
- [Conda](https://anaconda.org/conda-forge/eli5) (📥 94K · ⏱️ 25.01.2021):
	```
...
- [GitHub](https://github.com/sicara/tf-explain) (👨‍💻 14 · 🔀 77 · 📦 69 · 📋 80 - 41% open · ⏱️ 19.04.2021):
...
<details><summary><b><a href="https://github.com/fairlearn/fairlearn">fairlearn</a></b> (🥈22 ·  ⭐ 780) - A Python package to assess and improve fairness of machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/fairlearn/fairlearn) (👨‍💻 35 · 🔀 180 · 📋 200 - 35% open · ⏱️ 06.05.2021):
...
<details><summary><b><a href="https://github.com/Trusted-AI/AIX360">Explainability 360</a></b> (🥉21 ·  ⭐ 830) - Interpretability and explainability of data and machine.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Trusted-AI/AIX360) (👨‍💻 27 · 🔀 170 · 📦 16 · 📋 44 - 56% open · ⏱️ 02.05.2021):
...
<details><summary><b><a href="https://github.com/ModelOriented/DALEX">DALEX</a></b> (🥉20 ·  ⭐ 820) - moDel Agnostic Language for Exploration and eXplanation. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ModelOriented/DALEX) (👨‍💻 18 · 🔀 110 · 📦 12 · 📋 280 - 4% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/ModelOriented/DALEX
	```
- [PyPi](https://pypi.org/project/dalex) (📥 7.1K / month):
	```
	pip install dalex
	```
</details>
...
<details><summary><b><a href="https://github.com/oegedijk/explainerdashboard">explainerdashboard</a></b> (🥉20 ·  ⭐ 490) - Quickly build Explainable AI dashboards that show the inner.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 9 · 🔀 57 · 📦 19 · 📋 94 - 4% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/marcotcr/checklist) (👨‍💻 10 · 🔀 120 · 📦 7 · 📋 66 - 1% open · ⏱️ 30.03.2021):
...
- [GitHub](https://github.com/albermax/innvestigate) (👨‍💻 18 · 🔀 180 · 📦 56 · 📋 210 - 35% open · ⏱️ 16.10.2020):
...
<details><summary><b><a href="https://github.com/interpretml/DiCE">DiCE</a></b> (🥉18 ·  ⭐ 530) - Generate Diverse Counterfactual Explanations for any machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/interpretml/DiCE) (👨‍💻 11 · 🔀 74 · 📋 44 - 34% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/interpretml/DiCE
	```
- [PyPi](https://pypi.org/project/dice-ml) (📥 2.2K / month):
	```
	pip install dice-ml
	```
</details>
...
- [GitHub](https://github.com/kundajelab/deeplift) (👨‍💻 11 · 🔀 130 · 📦 44 · 📋 74 - 36% open · ⏱️ 11.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/deeplift) (📥 760 / month):
	```
...
- [GitHub](https://github.com/dssg/aequitas) (👨‍💻 16 · 🔀 70 · 📦 72 · 📋 53 - 60% open · ⏱️ 23.02.2021):

	```
	git clone https://github.com/dssg/aequitas
	```
- [PyPi](https://pypi.org/project/aequitas) (📥 870 / month):
	```
...
- [GitHub](https://github.com/csinva/imodels) (👨‍💻 3 · 🔀 20 · 📦 7 · ⏱️ 04.05.2021):

	```
	git clone https://github.com/csinva/imodels
	```
- [PyPi](https://pypi.org/project/imodels) (📥 330 / month):
	```
	pip install imodels
	```
</details>
...
- [GitHub](https://github.com/tensorflow/fairness-indicators) (👨‍💻 20 · 🔀 54 · ⏱️ 30.04.2021):

	```
	git clone https://github.com/tensorflow/fairness-indicators
	```
- [PyPi](https://pypi.org/project/fairness-indicators) (📥 750 / month):
	```
...
- [GitHub](https://github.com/EthicalML/xai) (👨‍💻 3 · 🔀 94 · 📦 11 · 📋 7 - 57% open · ⏱️ 23.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/xai) (📥 3.4K / month):
	```
	pip install xai
	```
</details>
...
- [GitHub](https://github.com/tensorflow/model-card-toolkit) (👨‍💻 9 · 🔀 28 · 📦 2 · 📋 6 - 66% open · ⏱️ 03.05.2021):
...
<details><summary><b><a href="https://github.com/tensorflow/tcav">tcav</a></b> (🥉16 ·  ⭐ 450) - Code for the TCAV ML interpretability project. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/tcav) (👨‍💻 18 · 🔀 110 · 📦 6 · 📋 49 - 4% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/aerdem4/lofo-importance) (👨‍💻 3 · 🔀 40 · 📦 4 · 📋 12 - 16% open · ⏱️ 02.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/lofo-importance) (📥 170 / month):
	```
...
<details><summary><b><a href="https://github.com/suinleelab/attributionpriors">Attribution Priors</a></b> (🥉13 ·  ⭐ 74) - Tools for training explainable models using.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/suinleelab/attributionpriors) (👨‍💻 6 · 🔀 6 · 📦 2 · 📋 4 - 25% open · ⏱️ 19.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/attributionpriors) (📥 40 / month):
	```
...
- [GitHub](https://github.com/intuit/bias-detector) (👨‍💻 3 · 🔀 4 · ⏱️ 25.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/bias-detector) (📥 200 / month):
	```
...
- [GitHub](https://github.com/facebookresearch/faiss) (👨‍💻 84 · 🔀 2.2K · 📦 360 · 📋 1.5K - 7% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/pymilvus) (📥 17K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/faiss) (📥 87K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/nmslib/nmslib) (👨‍💻 44 · 🔀 340 · 📦 370 · 📋 360 - 11% open · ⏱️ 16.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/nmslib) (📥 75K / month):
	```
	pip install nmslib
	```
- [Conda](https://anaconda.org/conda-forge/nmslib) (📥 26K · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/nmslib/hnswlib) (👨‍💻 41 · 🔀 260 · 📦 120 · 📋 190 - 43% open · ⏱️ 04.02.2021):
...
- [GitHub](https://github.com/lmcinnes/pynndescent) (👨‍💻 13 · 🔀 49 · 📦 440 · 📋 62 - 41% open · ⏱️ 12.03.2021):

	```
	git clone https://github.com/lmcinnes/pynndescent
	```
- [PyPi](https://pypi.org/project/pynndescent) (📥 390K / month):
	```
...
- [GitHub](https://github.com/milvus-io/milvus) (👨‍💻 140 · 🔀 850 · 📋 2.2K - 8% open · ⏱️ 06.05.2021):
...
- [PyPi](https://pypi.org/project/pymilvus) (📥 17K / month):
	...
	pip install pymilvus
	```
- [Docker Hub](https://hub.docker.com/r/milvusdb/milvus) (📥 320K · ⭐ 11 · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/kakao/n2) (👨‍💻 17 · 🔀 53 · 📦 15 · 📋 28 - 21% open · ⏱️ 21.10.2020):
...
- [GitHub](https://github.com/cornellius-gp/gpytorch) (👨‍💻 79 · 🔀 330 · 📦 270 · 📋 890 - 22% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/cornellius-gp/gpytorch
	```
- [PyPi](https://pypi.org/project/gpytorch) (📥 65K / month):
	```
...
- [GitHub](https://github.com/hmmlearn/hmmlearn) (👨‍💻 32 · 🔀 620 · 📦 960 · 📋 350 - 16% open · ⏱️ 16.04.2021):
...
- [PyPi](https://pypi.org/project/hmmlearn) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hmmlearn) (📥 78K · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 110 · 🔀 820 · 📦 440 · 📋 840 - 16% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 410 · 🔀 840 · 📦 1 · 📋 980 - 41% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/GPflow/GPflow) (👨‍💻 70 · 🔀 390 · 📦 250 · 📋 690 - 12% open · ⏱️ 29.04.2021):
...
- [PyPi](https://pypi.org/project/pomegranate) (📥 42K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pomegranate) (📥 56K · ⏱️ 01.11.2020):
	```
...
- [GitHub](https://github.com/pydata/patsy) (👨‍💻 13 · 🔀 80 · 📦 34K · 📋 120 - 57% open · ⏱️ 31.10.2018):
...
- [GitHub](https://github.com/pgmpy/pgmpy) (👨‍💻 91 · 🔀 560 · 📥 72 · 📦 220 · 📋 700 - 27% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/rlabbe/filterpy) (👨‍💻 36 · 🔀 420 · 📦 820 · 📋 180 - 17% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/rlabbe/filterpy
	```
- [PyPi](https://pypi.org/project/filterpy) (📥 44K / month):
	```
...
<details><summary><b><a href="https://github.com/raphaelvallat/pingouin">pingouin</a></b> (🥉23 ·  ⭐ 710) - Statistical package in Python based on Pandas. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/raphaelvallat/pingouin) (👨‍💻 18 · 🔀 58 · 📦 210 · 📋 130 - 8% open · ⏱️ 14.04.2021):

	```
	git clone https://github.com/raphaelvallat/pingouin
	```
- [PyPi](https://pypi.org/project/pingouin) (📥 32K / month):
	```
...
- [GitHub](https://github.com/SALib/SALib) (👨‍💻 26 · 🔀 140 · 📋 220 - 14% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 16 · 🔀 50 · 📦 13 · 📋 170 - 18% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/bambinos/bambi
	```
- [PyPi](https://pypi.org/project/bambi) (📥 410 / month):
	```
	pip install bambi
	```
</details>
...
- [GitHub](https://github.com/maximtrp/scikit-posthocs) (👨‍💻 8 · 🔀 22 · 📥 19 · 📋 40 - 10% open · ⏱️ 15.03.2021):
...
- [GitHub](https://github.com/pyro-ppl/funsor) (👨‍💻 9 · 🔀 14 · 📦 13 · 📋 130 - 46% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/pyro-ppl/funsor
	```
- [PyPi](https://pypi.org/project/funsor) (📥 520 / month):
	```
	pip install funsor
	```
</details>
...
- [GitHub](https://github.com/ElementAI/baal) (👨‍💻 8 · 🔀 32 · 📦 7 · 📋 44 - 29% open · ⏱️ 22.04.2021):
...
- [GitHub](https://github.com/uber/orbit) (👨‍💻 9 · 🔀 28 · 📦 4 · 📋 200 - 8% open · ⏱️ 28.04.2021):

	```
	git clone https://github.com/uber/orbit
	```
- [PyPi](https://pypi.org/project/orbit-ml) (📥 310 / month):
	```
	pip install orbit-ml
	```
</details>
<details><summary><b><a href="https://github.com/stan-dev/pystan">PyStan</a></b> (🥉16 ·  ⭐ 70) - PyStan, a Python interface to Stan, a platform for statistical modeling... <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/stan-dev/pystan) (👨‍💻 7 · 🔀 16 · 📋 130 - 7% open · ⏱️ 05.05.2021):
...
- [PyPi](https://pypi.org/project/pystan) (📥 1.2M / month):
	...
	pip install pystan
	```
- [Conda](https://anaconda.org/conda-forge/pystan) (📥 980K · ⏱️ 25.08.2020):
	```
...
- [GitHub](https://github.com/bethgelab/foolbox) (👨‍💻 31 · 🔀 340 · 📦 180 · 📋 320 - 16% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 34 · 🔀 170 · 📦 22 · 📋 120 - 34% open · ⏱️ 23.04.2021):

	```
	git clone https://github.com/QData/TextAttack
	```
- [PyPi](https://pypi.org/project/textattack) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (👨‍💻 66 · 🔀 600 · 📦 110 · 📋 490 - 12% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/MadryLab/robustness) (👨‍💻 12 · 🔀 97 · 📦 46 · 📋 60 - 13% open · ⏱️ 04.03.2021):
...
<details><summary><b><a href="https://github.com/BorealisAI/advertorch">advertorch</a></b> (🥉16 ·  ⭐ 850 · 💤) - A Toolbox for Adversarial Robustness Research. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/BorealisAI/advertorch) (👨‍💻 16 · 🔀 140 · 📦 36 · 📋 41 - 31% open · ⏱️ 15.06.2020):
...
- [GitHub](https://github.com/cupy/cupy) (👨‍💻 260 · 🔀 450 · 📥 16K · 📦 730 · 📋 1.3K - 22% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/cupy/cupy
	```
- [PyPi](https://pypi.org/project/cupy) (📥 92K / month):
	```
	pip install cupy
	```
- [Conda](https://anaconda.org/conda-forge/cupy) (📥 560K · ⏱️ 30.04.2021):
	```
	conda install -c conda-forge cupy
	```
- [Docker Hub](https://hub.docker.com/r/cupy/cupy) (📥 50K · ⭐ 6 · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/wookayin/gpustat) (👨‍💻 12 · 🔀 180 · 📦 830 · 📋 64 - 23% open · ⏱️ 23.03.2021):
...
- [PyPi](https://pypi.org/project/gpustat) (📥 390K / month):
	...
	pip install gpustat
	```
- [Conda](https://anaconda.org/conda-forge/gpustat) (📥 53K · ⏱️ 24.11.2020):
	```
...
- [GitHub](https://github.com/NVIDIA/apex) (👨‍💻 82 · 🔀 710 · 📦 540 · 📋 820 - 54% open · ⏱️ 19.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nvidia-apex) (📥 43K · ⏱️ 22.04.2021):
	```
...
- [GitHub](https://github.com/anderskm/gputil) (👨‍💻 13 · 🔀 80 · 📦 1.2K · 📋 25 - 44% open · ⏱️ 16.08.2019):
...
- [GitHub](https://github.com/fbcotter/py3nvml) (👨‍💻 6 · 🔀 21 · 📦 260 · 📋 11 - 9% open · ⏱️ 23.04.2020):
...
- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 210 · 🔀 510 · 📋 3.6K - 15% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/arrayfire/arrayfire) (👨‍💻 82 · 🔀 470 · 📥 1.1K · 📋 1.5K - 15% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/NVIDIA/DALI) (👨‍💻 57 · 🔀 390 · 📋 900 - 11% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/inducer/pycuda) (👨‍💻 70 · 🔀 220 · 📦 830 · 📋 180 - 24% open · ⏱️ 16.04.2021):
...
- [GitHub](https://github.com/lebedov/scikit-cuda) (👨‍💻 44 · 🔀 160 · 📦 130 · 📋 210 - 20% open · ⏱️ 30.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/scikit-cuda) (📥 880 / month):
	```
...
- [GitHub](https://github.com/rapidsai/cuml) (👨‍💻 130 · 🔀 330 · 📋 1.7K - 34% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/EthicalML/vulkan-kompute) (👨‍💻 11 · 🔀 30 · 📥 54 · 📦 2 · 📋 140 - 32% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/BlazingDB/blazingsql) (👨‍💻 42 · 🔀 140 · 📋 680 - 16% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 61 · 🔀 140 · 📋 640 - 16% open · ⏱️ 06.05.2021):
...
<details><summary><b><a href="https://github.com/nicolargo/nvidia-ml-py3">nvidia-ml-py3</a></b> (🥉16 ·  ⭐ 66 · 💀) - Python 3 Bindings for the NVIDIA Management Library. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/nicolargo/nvidia-ml-py3) (👨‍💻 2 · 🔀 14 · 📦 3.2K · ⏱️ 06.03.2019):
...
- [GitHub](https://github.com/rapidsai/cusignal) (👨‍💻 30 · 🔀 63 · 📋 100 - 5% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/tensorflow/tensor2tensor) (👨‍💻 230 · 🔀 2.8K · 📦 960 · 📋 1.2K - 45% open · ⏱️ 03.05.2021):

	```
	git clone https://github.com/tensorflow/tensor2tensor
	```
- [PyPi](https://pypi.org/project/tensor2tensor) (📥 150K / month):
	```
...
- [GitHub](https://github.com/tensorflow/hub) (👨‍💻 69 · 🔀 1.5K · 📦 6.5K · 📋 580 - 5% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/tensorflow/addons) (👨‍💻 160 · 🔀 420 · 📦 2.9K · 📋 800 - 19% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/tensorflow/transform) (👨‍💻 27 · 🔀 170 · 📦 450 · 📋 160 - 14% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/tensorflow/transform
	```
- [PyPi](https://pypi.org/project/tensorflow-transform) (📥 7.5M / month):
	```
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 50 · 🔀 230 · 📦 770 · 📋 180 - 34% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/qubvel/efficientnet) (👨‍💻 8 · 🔀 400 · 📥 170K · 📦 590 · 📋 100 - 46% open · ⏱️ 15.09.2020):
...
- [GitHub](https://github.com/tensorflow/cloud) (👨‍💻 18 · 🔀 48 · 📦 51 · 📋 68 - 63% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/tensorflow/io) (👨‍💻 73 · 🔀 150 · 📋 410 - 30% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/tensorflow/neural-structured-learning) (👨‍💻 27 · 🔀 140 · 📦 59 · 📋 46 - 10% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/tensorflow/compression) (👨‍💻 10 · 🔀 170 · ⏱️ 23.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-compression) (📥 920 / month):
	```
...
- [GitHub](https://github.com/PAIR-code/saliency) (👨‍💻 14 · 🔀 150 · 📦 15 · 📋 23 - 52% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/scikit-learn-contrib/imbalanced-learn) (👨‍💻 56 · 🔀 1K · 📦 5.2K · 📋 460 - 6% open · ⏱️ 25.04.2021):
...
- [GitHub](https://github.com/rasbt/mlxtend) (👨‍💻 83 · 🔀 700 · 📦 3.1K · 📋 370 - 22% open · ⏱️ 26.04.2021):
...
- [GitHub](https://github.com/iskandr/fancyimpute) (👨‍💻 11 · 🔀 150 · 📦 930 · 📋 110 - 2% open · ⏱️ 25.01.2021):
...
- [GitHub](https://github.com/guofei9987/scikit-opt) (👨‍💻 10 · 🔀 510 · 📦 31 · 📋 98 - 23% open · ⏱️ 03.04.2021):
...
- [GitHub](https://github.com/scikit-multilearn/scikit-multilearn) (👨‍💻 15 · 🔀 120 · 📦 420 · 📋 160 - 41% open · ⏱️ 21.05.2019):
...
- [GitHub](https://github.com/yzhao062/combo) (🔀 84 · 📦 330 · 📋 12 - 75% open · ⏱️ 15.03.2021):
...
- [GitHub](https://github.com/scikit-learn-contrib/lightning) (👨‍💻 17 · 🔀 170 · 📦 82 · 📋 82 - 53% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/scikit-learn-contrib/lightning
	```
- [PyPi](https://pypi.org/project/sklearn-contrib-lightning) (📥 420 / month):
	```
...
- [GitHub](https://github.com/koaning/scikit-lego) (👨‍💻 45 · 🔀 70 · 📦 21 · 📋 220 - 11% open · ⏱️ 04.05.2021):
...
- [PyPi](https://pypi.org/project/scikit-lego) (📥 3.4K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scikit-lego) (📥 11K · ⏱️ 02.11.2020):
	```
...
<details><summary><b><a href="https://github.com/scikit-learn-contrib/skope-rules">skope-rules</a></b> (🥉19 ·  ⭐ 380 · 💤) - machine learning with logical rules in Python. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/skggm/skggm) (👨‍💻 5 · 🔀 31 · 📦 6 · 📋 75 - 37% open · ⏱️ 24.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/skggm) (📥 170 / month):
	```
	pip install skggm
	```
</details>
...
<details><summary><b><a href="https://github.com/mathurinm/celer">celer</a></b> (🥉16 ·  ⭐ 110) - Fast solver for L1-type problems: Lasso, sparse Logisitic regression,.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/amueller/dabl">dabl</a></b> (🥉13 ·  ⭐ 72 · 💤) - Data Analysis Baseline Library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/Cadene/pretrained-models.pytorch">pretrainedmodels</a></b> (🥇26 ·  ⭐ 7.9K · 💀) - Pretrained ConvNets for pytorch: NASNet, ResNeXt,.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/KevinMusgrave/pytorch-metric-learning) (👨‍💻 15 · 🔀 410 · 📦 79 · 📋 250 - 17% open · ⏱️ 03.04.2021):

	```
	git clone https://github.com/KevinMusgrave/pytorch-metric-learning
	```
- [PyPi](https://pypi.org/project/pytorch-metric-learning) (📥 17K / month):
	```
	pip install pytorch-metric-learning
	```
- [Conda](https://anaconda.org/metric-learning/pytorch-metric-learning) (📥 2.2K · ⏱️ 03.04.2021):
	```
...
- [GitHub](https://github.com/jettify/pytorch-optimizer) (👨‍💻 19 · 🔀 170 · 📦 190 · 📋 31 - 19% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/lukemelas/EfficientNet-PyTorch) (👨‍💻 24 · 🔀 1.1K · 📥 480K · 📋 240 - 45% open · ⏱️ 15.04.2021):
...
- [GitHub](https://github.com/rtqichen/torchdiffeq) (👨‍💻 19 · 🔀 590 · 📦 91 · 📋 130 - 15% open · ⏱️ 23.03.2021):
...
- [GitHub](https://github.com/lucidrains/reformer-pytorch) (👨‍💻 10 · 🔀 190 · 📋 110 - 9% open · ⏱️ 05.05.2021):
...
<details><summary><b><a href="https://github.com/dreamquark-ai/tabnet">TabNet</a></b> (🥈21 ·  ⭐ 990) - PyTorch implementation of TabNet paper :.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/dreamquark-ai/tabnet) (👨‍💻 18 · 🔀 190 · 📋 130 - 17% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/rwightman/gen-efficientnet-pytorch) (👨‍💻 5 · 🔀 180 · 📦 49 · ⏱️ 30.11.2020):

	```
	git clone https://github.com/rwightman/gen-efficientnet-pytorch
	```
- [PyPi](https://pypi.org/project/geffnet) (📥 5.1K / month):
	```
	pip install geffnet
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/higher) (👨‍💻 8 · 🔀 80 · 📦 51 · 📋 80 - 40% open · ⏱️ 02.03.2021):
...
- [GitHub](https://github.com/GRAAL-Research/poutyne) (👨‍💻 16 · 🔀 50 · 📦 59 · 📋 43 - 13% open · ⏱️ 15.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/poutyne) (📥 1.2K / month):
	```
	pip install poutyne
	```
</details>
...
- [GitHub](https://github.com/lucidrains/performer-pytorch) (👨‍💻 4 · 🔀 74 · 📦 19 · 📋 59 - 35% open · ⏱️ 21.04.2021):
...
- [GitHub](https://github.com/tristandeleu/pytorch-meta) (👨‍💻 10 · 🔀 150 · 📦 37 · 📋 100 - 25% open · ⏱️ 19.03.2021):

	```
	git clone https://github.com/tristandeleu/pytorch-meta
	```
- [PyPi](https://pypi.org/project/torchmeta) (📥 990 / month):
	```
...
- [GitHub](https://github.com/geohot/tinygrad) (👨‍💻 43 · 🔀 480 · 📦 1 · 📋 76 - 17% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/geohot/tinygrad
	```
</details>
<details><summary><b><a href="https://github.com/google-research/torchsde">torchsde</a></b> (🥉16 ·  ⭐ 710) - Differentiable SDE solvers with GPU support and efficient.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google-research/torchsde) (👨‍💻 4 · 🔀 64 · 📋 36 - 13% open · ⏱️ 10.04.2021):
...
- [GitHub](https://github.com/achaiah/pywick) (👨‍💻 4 · 🔀 35 · 📦 3 · 📋 12 - 25% open · ⏱️ 01.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pywick) (📥 280 / month):
	```
	pip install pywick
	```
</details>
<details><summary><b><a href="https://github.com/harvardnlp/pytorch-struct">Torch-Struct</a></b> (🥉14 ·  ⭐ 930) - Fast, general, and tested differentiable structured prediction.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/karpathy/micrograd) (👨‍💻 2 · 🔀 130 · 📦 1 · 📋 5 - 40% open · ⏱️ 18.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/micrograd) (📥 21 / month):
	```
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.2K · 🔀 3.6K · 📥 320K · 📦 340K · 📋 7.2K - 18% open · ⏱️ 06.05.2021):
...
- [GitHub](https://github.com/HIPS/autograd) (👨‍💻 51 · 🔀 720 · 📦 1.9K · 📋 360 - 39% open · ⏱️ 03.03.2021):
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 23 · 🔀 890 · 📦 610 · 📋 190 - 54% open · ⏱️ 27.04.2021):
...
- [GitHub](https://github.com/streamlit/streamlit) (👨‍💻 100 · 🔀 1.2K · 📦 76 · 📋 1.7K - 29% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/streamlit/streamlit
	```
- [PyPi](https://pypi.org/project/streamlit) (📥 260K / month):
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/hdbscan) (👨‍💻 69 · 🔀 330 · 📦 830 · 📋 370 - 60% open · ⏱️ 07.04.2021):
...
- [GitHub](https://github.com/carla-simulator/carla) (👨‍💻 120 · 🔀 1.7K · 📦 65 · 📋 3.2K - 10% open · ⏱️ 21.04.2021):

	```
	git clone https://github.com/carla-simulator/carla
	```
- [PyPi](https://pypi.org/project/carla) (📥 810 / month):
	```
	pip install carla
	```
</details>
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 160 · 🔀 930 · 📦 40 · 📋 1.2K - 27% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 3.7K / month):
	```
...
- [GitHub](https://github.com/wireservice/agate) (👨‍💻 47 · 🔀 130 · 📦 560 · 📋 630 - 7% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/agate) (📥 540K / month):
	```
	pip install agate
	```
...
- [GitHub](https://github.com/google/trax) (👨‍💻 68 · 🔀 580 · 📦 26 · 📋 180 - 39% open · ⏱️ 05.05.2021):
...
- [PyPi](https://pypi.org/project/blis) (📥 1.8M / month):
	...
	pip install blis
	```
- [Conda](https://anaconda.org/conda-forge/cython-blis) (📥 780K · ⏱️ 31.01.2021):
	```
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 55 · 🔀 140 · 📦 52 · 📋 660 - 14% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/serge-sans-paille/pythran
	```
- [PyPi](https://pypi.org/project/pythran) (📥 11K / month):
	```
	pip install pythran
	```
- [Conda](https://anaconda.org/conda-forge/pythran) (📥 150K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/annoviko/pyclustering) (👨‍💻 26 · 🔀 190 · 📥 320 · 📦 200 · 📋 630 - 7% open · ⏱️ 12.02.2021):
...
- [GitHub](https://github.com/pyjanitor-devs/pyjanitor) (👨‍💻 88 · 🔀 120 · 📦 95 · 📋 380 - 25% open · ⏱️ 20.04.2021):

	```
	git clone https://github.com/ericmjl/pyjanitor
	```
- [PyPi](https://pypi.org/project/pyjanitor) (📥 7.3K / month):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleHub) (👨‍💻 37 · 🔀 1.1K · 📥 500 · 📦 180 · 📋 780 - 28% open · ⏱️ 27.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/paddlehub) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/uber/causalml) (👨‍💻 26 · 🔀 280 · 📦 18 · 📋 170 - 17% open · ⏱️ 29.04.2021):
...
- [GitHub](https://github.com/tableau/TabPy) (👨‍💻 40 · 🔀 400 · 📦 58 · 📋 270 - 3% open · ⏱️ 04.02.2021):

	```
	git clone https://github.com/tableau/TabPy
	```
- [PyPi](https://pypi.org/project/tabpy) (📥 26K / month):
	```
	pip install tabpy
	```
</details>
...
- [GitHub](https://github.com/minrk/findspark) (👨‍💻 14 · 🔀 68 · 📦 1.7K · 📋 18 - 55% open · ⏱️ 08.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/findspark) (📥 1.1M / month):
	```
...
<details><summary><b><a href="https://github.com/ljvmiranda921/pyswarms">PySwarms</a></b> (🥉22 ·  ⭐ 770) - A research toolkit for particle swarm optimization in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ljvmiranda921/pyswarms) (👨‍💻 43 · 🔀 240 · 📦 110 · 📋 180 - 12% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyswarms) (📥 5K / month):
	```
	pip install pyswarms
	```
</details>
<details><summary><b><a href="https://github.com/gradio-app/gradio">Gradio</a></b> (🥉21 ·  ⭐ 2.5K) - Wrap UIs around any model, share with anyone. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 17 · 🔀 160 · 📦 120 · 📋 99 - 4% open · ⏱️ 30.04.2021):

	```
	git clone https://github.com/gradio-app/gradio
	```
- [PyPi](https://pypi.org/project/gradio) (📥 5.3K / month):
	```
	pip install gradio
	```
</details>
...
- [GitHub](https://github.com/cgnorthcutt/cleanlab) (👨‍💻 6 · 🔀 180 · 📦 11 · 📋 59 - 30% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/inducer/pyopencl) (👨‍💻 86 · 🔀 210 · 📦 510 · 📋 270 - 20% open · ⏱️ 03.05.2021):
...
<details><summary><b><a href="https://github.com/MaxHalford/prince">Prince</a></b> (🥉20 ·  ⭐ 630) - Python factor analysis library (PCA, CA, MCA, MFA, FAMD). <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/MaxHalford/prince) (👨‍💻 8 · 🔀 120 · 📦 120 · 📋 93 - 30% open · ⏱️ 11.01.2021):

	```
	git clone https://github.com/MaxHalford/prince
	```
- [PyPi](https://pypi.org/project/prince) (📥 8.4K / month):
	```
	pip install prince
	```
</details>
<details><summary><b><a href="https://github.com/solegalli/feature_engine">Feature Engine</a></b> (🥉20 ·  ⭐ 520) - Feature engineering package with sklearn like functionality. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/solegalli/feature_engine) (👨‍💻 23 · 🔀 140 · 📋 110 - 24% open · ⏱️ 01.05.2021):
...
- [PyPi](https://pypi.org/project/feature_engine) (📥 22K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/feature_engine) (📥 2.8K · ⏱️ 25.01.2021):
	```
...
- [GitHub](https://github.com/rasbt/biopandas) (👨‍💻 7 · 🔀 77 · 📦 53 · 📋 36 - 41% open · ⏱️ 07.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/biopandas) (📥 930 / month):
	```
...
- [GitHub](https://github.com/yzhao062/SUOD) (🔀 30 · 📦 320 · 📋 5 - 60% open · ⏱️ 19.01.2021):

	```
	git clone https://github.com/yzhao062/SUOD
	```
- [PyPi](https://pypi.org/project/suod) (📥 18K / month):
	```
	pip install suod
	```
</details>
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 64 · 🔀 200 · 📦 9 · 📋 290 - 7% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/trevorstephens/gplearn) (👨‍💻 9 · 🔀 160 · 📦 150 · 📋 160 - 22% open · ⏱️ 15.02.2020):
...
- [GitHub](https://github.com/eltonlaw/impyute) (👨‍💻 9 · 🔀 41 · 📦 91 · 📋 62 - 41% open · ⏱️ 05.10.2019):

	```
	git clone https://github.com/eltonlaw/impyute
	```
- [PyPi](https://pypi.org/project/impyute) (📥 3K / month):
	```
	pip install impyute
	```
</details>
